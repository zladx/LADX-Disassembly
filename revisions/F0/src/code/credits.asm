...
Data_017_44AC::
    db   $00, $01, $02, $03, $04, $04, $04, $05, $05, $06, $07, $08, $09, $0A, $0A, $0A
    db   $0B, $0B, $0C, $02, $0D, $03, $03, $04, $04, $05, $05, $06, $06, $06, $0E, $09
    db   $0A, $0A, $0A, $0A, $11, $0F, $10, $11
...
jr_017_7E88:
    ...
    ld   [hl], a                                  ; $7FB7: $77
    call Farcall                                  ; $7e3b: $cd $c7 $0b
    ld a, $01                                     ; $7e3e: $3e $01
jr_017_7e40:
    ld [wPaletteDataFlags], a                     ; $7e40: $ea $d1 $dd
    ret                                           ; $7e43: $c9
func_017_7F30::
    and $01                                       ; $7e44: $e6 $01
    jr z, jr_017_7e50                             ; $7e46: $28 $08

func_017_7EA4::
    xor a                                         ; $7e48: $af
    ld [$d01f], a                                 ; $7e49: $ea $1f $d0
    ld a, $02                                     ; $7e4c: $3e $02
    jr jr_017_7e64                                ; $7e4e: $18 $14

jr_017_7e50:
    ld hl, wFarcallBank                           ; $7e50: $21 $01 $de
    ld a, $20                                     ; $7e53: $3e $20
    ld [hl+], a                                   ; $7e55: $22
    ld a, $7e                                     ; $7e56: $3e $7e
    ld [hl+], a                                   ; $7e58: $22
    ...
    ld a, $17                                     ; $7e5c: $3e $17
    ld [hl], a                                    ; $7e5e: $77
    call Farcall                                  ; $7e5f: $cd $c7 $0b
    ld a, $01                                     ; $7e62: $3e $01

jr_017_7e64:
    ld [wPaletteDataFlags], a                     ; $7e64: $ea $d1 $dd
    xor a                                         ; $7e67: $af
    ret                                           ; $7e68: $c9


func_017_7FA9:
    ld hl, wFarcallBank                           ; $7e69: $21 $01 $de
    ld a, $20                                     ; $7e6c: $3e $20
    ld [hl+], a                                   ; $7e6e: $22
    ld a, $7d                                     ; $7e6f: $3e $7d
    ld [hl+], a                                   ; $7e71: $22
