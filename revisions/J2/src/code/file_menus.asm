...
jr_001_4e1a:
    ldh [hScratch4], a                            ; $4e1a: $e0 $db
    ld a, [hl]                                    ; $4e1c: $7e
    ldh [hScratch2], a                            ; $4e1d: $e0 $d9
    ld a, [de]                                    ; $4e1f: $1a
    cp $03                                        ; $4e20: $fe $03
    jr nc, .else                            ; $4e22: $30 $02
    ld a, $03                                     ; $4e24: $3e $03
.else
    cp $0e                                        ; $4e26: $fe $0e
    jr c, .clamp                             ; $4e28: $38 $02
    ld a, $0e                                     ; $4e2a: $3e $0e
.clamp
ld [de], a                                    ; $4e2c: $12
    ldh [hScratch3], a                            ; $4e2d: $e0 $da
    swap a                                        ; $4e2f: $cb $37
    srl a                                         ; $4e31: $cb $3f
    cp [hl]                                       ; $4e33: $be
    jp nc, label_001_5D53                            ; $4e34: $d2 $c5 $5d

    ld [hl], a                                    ; $4e37: $77
    ldh [hScratch2], a                            ; $4e38: $e0 $d9
    jp label_001_5D53                                ; $4e3a: $c3 $c5 $5d
...
func_001_4DBE::
    ...
    ld a, $01                                     ; $4e43: $3e $01
    ld hl, $dc07                                  ; $4e45: $21 $07 $dc
    ld de, $dc0a                                  ; $4e48: $11 $0a $dc
    jr jr_001_4e1a
...
func_001_4DD6::
    ...
    ld a, $02                                     ; $4e53: $3e $02
    ld hl, $dc08                                  ; $4e55: $21 $08 $dc
    ld de, $dc0b                                  ; $4e58: $11 $0b $dc
    jr jr_001_4e1a                                ; $4e5b: $18 $bd
...
jr_001_4F1D::
    ...
    ld   e, a                                     ; $4F26: $5F
    ld a, [wGameplayType]                         ; $4f6b: $fa $95 $db
    cp $05                                        ; $4f6e: $fe $05
    ld a, $1c                                     ; $4f70: $3e $1c
    jr nz, jr_001_4f76                            ; $4f72: $20 $02
