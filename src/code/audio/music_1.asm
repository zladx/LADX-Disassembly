...
jr_01B_48EB:
    ...
    nop                                           ; $4909: $00
    nop                                           ; $490A: $00
    ld   bc, $200                                 ; $490B: $01 $00 $02
    nop                                           ; $490E: $00
    ld   bc, $00                                  ; $490F: $01 $00 $00
    rst  $38                                      ; $4912: $FF
    rst  $38                                      ; $4913: $FF
    rst  $38                                      ; $4914: $FF
    cp   $FF                                      ; $4915: $FE $FF
...
jr_01B_4A96:
    ld   bc, $101                                 ; $4A96: $01 $01 $01
    ld   bc, $130                                 ; $4A99: $01 $30 $01
    inc  bc                                       ; $4A9C: $03
    ld   b, $0C                                   ; $4A9D: $06 $0C
...
jr_01B_4C87:
    ...
    nop                                           ; $4CCB: $00
    and  a                                        ; $4CCC: $A7
    ld   bc, $1A1                                 ; $4CCD: $01 $A1 $01
    xor  d                                        ; $4CD0: $AA
    ld   bc, $1A5                                 ; $4CD1: $01 $A5 $01
    and  c                                        ; $4CD4: $A1
    rst  $38                                      ; $4CD5: $FF
    and  d                                        ; $4CD6: $A2
    rst  $38                                      ; $4CD7: $FF
...
jr_01B_4D4A:
    ld   bc, $1A1                                 ; $4D4A: $01 $A1 $01
    sbc  h                                        ; $4D4D: $9C
    and  [hl]                                     ; $4D4E: $A6
    ld   bc, $30AA                                ; $4D4F: $01 $AA $30
    ld   bc, $1A0                                 ; $4D52: $01 $A0 $01
    and  c                                        ; $4D55: $A1
    ld   bc, $29B                                 ; $4D56: $01 $9B $02
    xor  d                                        ; $4D59: $AA
...
jr_01B_4D69:
    ld   bc, $1A1                                 ; $4D69: $01 $A1 $01
    sbc  h                                        ; $4D6C: $9C
    and  [hl]                                     ; $4D6D: $A6
    ld   bc, $30AA                                ; $4D6E: $01 $AA $30
    ld   bc, $1A0                                 ; $4D71: $01 $A0 $01
    and  c                                        ; $4D74: $A1
    ld   bc, $29B                                 ; $4D75: $01 $9B $02
    xor  d                                        ; $4D78: $AA
