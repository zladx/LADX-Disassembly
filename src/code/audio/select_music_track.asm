...
HouseMusicTracks::
    db   MUSIC_TAIL_CAVE, MUSIC_BOTTLE_GROTTO, MUSIC_KEY_CAVERN, MUSIC_ANGLERS_TUNNEL, MUSIC_CATFISH_MAW, MUSIC_FACE_SHRINE, MUSIC_EAGLES_TOWER, MUSIC_TURTLE_ROCK, MUSIC_EGG_MAZE, MUSIC_COLOR_DUNGEON, MUSIC_CAVE, MUSIC_CAVE, MUSIC_CAVE, MUSIC_CAVE, MUSIC_SHOP, MUSIC_MINIGAME
    db   MUSIC_HOUSE, MUSIC_CAVE, MUSIC_TOWN_HOUSE, MUSIC_DREAM_SHRINE, MUSIC_KANALET_CASTLE, MUSIC_MOBLIN_HIDEOUT, MUSIC_SOUTHERN_SHRINE, MUSIC_NONE, MUSIC_NONE, MUSIC_NONE, MUSIC_NONE, MUSIC_NONE, MUSIC_NONE, MUSIC_HOUSE, MUSIC_GHOST_HOUSE, MUSIC_CAVE
