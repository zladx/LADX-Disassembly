...
jr_01F_49F7:
    ...
    or   b                                        ; $49F9: $B0
    add  a                                        ; $49FA: $87
    ld   bc, $0000                                ; $49FB: $01 $00 $00
    ld   h, d                                     ; $49FE: $62
    and  a                                        ; $49FF: $A7
    add  a                                        ; $4A00: $87
    ld   bc, $0000                                ; $4A01: $01 $00 $00
    db   $10                                      ; $4A04: $10
    and  a                                        ; $4A05: $A7
    add  a                                        ; $4A06: $87
...
jr_01F_4CBE:
    ...
    db   $10                                      ; $4CD8: $10
    add  a                                        ; $4CD9: $87
    ld   bc, $0000                                ; $4CDA: $01 $00 $00
    ld   b, a                                     ; $4CDD: $47
    ld   [hl], b                                  ; $4CDE: $70
    add  a                                        ; $4CDF: $87
    ld   bc, $033E                                ; $4CE0: $01 $3E $03
...
jr_01F_4F00:
    ...
    nop                                           ; $4F05: $00
    ld   bc, $0100                                ; $4F06: $01 $00 $01
    nop                                           ; $4F09: $00
    ld   bc, $0100                                ; $4F0A: $01 $00 $01
    nop                                           ; $4F0D: $00
    ld   bc, $0100                                ; $4F0E: $01 $00 $01
    nop                                           ; $4F11: $00
    ld   bc, $0100                                ; $4F12: $01 $00 $01
    rst  $38                                      ; $4F15: $FF
    ...
    add  a                                        ; $4F1B: $87
    ld   bc, $0000                                ; $4F1C: $01 $00 $00
    and  a                                        ; $4F1F: $A7
    ret  c                                        ; $4F20: $D8

    add  a                                        ; $4F21: $87
    ld   bc, $053E                                ; $4F22: $01 $3E $05
...
jr_01F_518B:
    ...
    rst  $38                                      ; $51AA: $FF
    and  b                                        ; $51AB: $A0
    ld   bc, $0000                                ; $51AC: $01 $00 $00
    nop                                           ; $51AF: $00
    add  a                                        ; $51B0: $87
    add  b                                        ; $51B1: $80
    add  a                                        ; $51B2: $87
    ld   bc, $023E                                ; $51B3: $01 $3E $02
...
jr_01F_51CF:
    ...
    ld   [bc], a                                  ; $51E7: $02
    nop                                           ; $51E8: $00
    ld   bc, $0100                                ; $51E9: $01 $00 $01
    nop                                           ; $51EC: $00
    ld   bc, $0100                                ; $51ED: $01 $00 $01
    nop                                           ; $51F0: $00
    nop                                           ; $51F1: $00
    ld   h, b                                     ; $51F2: $60
    ret  nc                                       ; $51F3: $D0
...
jr_01F_5C5F:
    ...
    add  h                                        ; $5C72: $84
    ld   bc, $0080                                ; $5C73: $01 $80 $00
    jr   nz, @+$28                                ; $5C76: $20 $26

    add  h                                        ; $5C78: $84
    ld   bc, $0080                                ; $5C79: $01 $80 $00
    jr   nz, @+$0A                                ; $5C7C: $20 $08
...
jr_01F_68D0:
    ...
    add  b                                        ; $68D5: $80
    ld   bc, $004B                                ; $68D6: $01 $4B $00
    ld   bc, $005E                                ; $68D9: $01 $5E $00
    ld   bc, $005D                                ; $68DC: $01 $5D $00
    ld   [bc], a                                  ; $68DF: $02
    ld   l, h                                     ; $68E0: $6C
    nop                                           ; $68E1: $00
    ld   [bc], a                                  ; $68E2: $02
...
jr_01F_6A7A:
    ...
    inc  l                                        ; $6B1D: $2C
    add  b                                        ; $6B1E: $80
    ld   bc, $003C                                ; $6B1F: $01 $3C $00
    ld   bc, $004C                                ; $6B22: $01 $4C $00
    ld   bc, $005C                                ; $6B25: $01 $5C $00
    ld   bc, $006C                                ; $6B28: $01 $6C $00
    ld   bc, $007C                                ; $6B2B: $01 $7C $00
...
jr_01F_6CEE:
    ...
    ld   b, $80                                   ; $6D02: $06 $80
    ld   bc, $0006                                ; $6D04: $01 $06 $00
    ld   bc, $0048                                ; $6D07: $01 $48 $00
...
jr_01F_6D21:
    ...
    dec  bc                                       ; $6D2C: $0B
    add  b                                        ; $6D2D: $80
    ld   bc, $000C                                ; $6D2E: $01 $0C $00
    ld   bc, $000B                                ; $6D31: $01 $0B $00
...
jr_01F_6E6D:
    ...
    ld   bc, $005C                                ; $6EBE: $01 $5C $00
    ld   bc, $004F                                ; $6EC1: $01 $4F $00
    ld   bc, $004E                                ; $6EC4: $01 $4E $00
    ld   bc, $005D                                ; $6EC7: $01 $5D $00
    ld   bc, $005E                                ; $6ECA: $01 $5E $00
    ld   bc, $005F                                ; $6ECD: $01 $5F $00
    ld   bc, $006C                                ; $6ED0: $01 $6C $00
    ld   bc, $006D                                ; $6ED3: $01 $6D $00
    ld   bc, $006E                                ; $6ED6: $01 $6E $00
    ld   bc, $006F                                ; $6ED9: $01 $6F $00
    db   $10                                      ; $6EDC: $10
    ld   a, $05                                   ; $6EDD: $3E $05
...
jr_01F_6EFC:
    ...
    ld   l, h                                     ; $6F1F: $6C
    add  b                                        ; $6F20: $80
    ld   bc, $006C                                ; $6F21: $01 $6C $00
    ld   bc, $006B                                ; $6F24: $01 $6B $00
    ld   bc, $006A                                ; $6F27: $01 $6A $00
    ld   bc, $0069                                ; $6F2A: $01 $69 $00
    ld   bc, $0068                                ; $6F2D: $01 $68 $00
    ld   [bc], a                                  ; $6F30: $02
    ld   a, $05                                   ; $6F31: $3E $05
...
jr_01F_6F9F:
    ...
    ld   l, l                                     ; $6FC5: $6D
    add  b                                        ; $6FC6: $80
    ld   bc, $0074                                ; $6FC7: $01 $74 $00
    ld   bc, $005F                                ; $6FCA: $01 $5F $00
    ld   bc, $0066                                ; $6FCD: $01 $66 $00
    ld   bc, $005D                                ; $6FD0: $01 $5D $00
    ld   bc, $0064                                ; $6FD3: $01 $64 $00
    ld   bc, $004F                                ; $6FD6: $01 $4F $00
    ld   bc, $0062                                ; $6FD9: $01 $62 $00
...
jr_01F_73FD:
    ...
    sbc  h                                        ; $7417: $9C
    add  b                                        ; $7418: $80
    ld   bc, $008E                                ; $7419: $01 $8E $00
    ld   bc, $007E                                ; $741C: $01 $7E $00
    ld   bc, $008C                                ; $741F: $01 $8C $00
    ld   bc, $007C                                ; $7422: $01 $7C $00
    ld   bc, $006F                                ; $7425: $01 $6F $00
    ld   bc, $006D                                ; $7428: $01 $6D $00
    ld   bc, $005F                                ; $742B: $01 $5F $00
    ld   bc, $005D                                ; $742E: $01 $5D $00
    ld   bc, $004F                                ; $7431: $01 $4F $00
    ld   bc, $004D                                ; $7434: $01 $4D $00
    ld   bc, $003F                                ; $7437: $01 $3F $00
    ld   bc, $003D                                ; $743A: $01 $3D $00
...
jr_01F_75AB:
    ...
    rrca                                          ; $75C8: $0F
    add  b                                        ; $75C9: $80
    ld   bc, $000E                                ; $75CA: $01 $0E $00
    ld   bc, $000D                                ; $75CD: $01 $0D $00
    ld   bc, $000C                                ; $75D0: $01 $0C $00
    ld   bc, $000B                                ; $75D3: $01 $0B $00
    ld   bc, $000A                                ; $75D6: $01 $0A $00
...
label_01F_7B11:
    ...
    ld   bc, $0180                                ; $7B4A: $01 $80 $01
    nop                                           ; $7B4D: $00
    ld   e, c                                     ; $7B4E: $59
    ld   de, $0380                                ; $7B4F: $11 $80 $03
    ld   bc, $17C8                                ; $7B52: $01 $C8 $17
    add  b                                        ; $7B55: $80
    ld   bc, $F500                                ; $7B56: $01 $00 $F5
    ld   de, $0180                                ; $7B59: $11 $80 $01
