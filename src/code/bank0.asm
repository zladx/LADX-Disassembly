...
GetEntityDropTimer::
    ld   hl, wEntitiesDropTimerTable              ; $00:0BFB: $21 $50 $C4
...
.randomEnd
    ...
    ld   [hl], a                                  ; $00:16A6: $77
    ld   hl, wEntitiesDropTimerTable              ; $00:16A7: $21 $50 $C4
...
.isIndoorEnd
    ...
    cp   ROOM_OW_EAGLE_TOWER                      ; $00:31C1: $FE $0E
    jr   nz, .endEaglesTowerAlt                   ; $00:31C3: $20 $0C
    ld   a, [wOverworldRoomStatus + ROOM_OW_EAGLE_TOWER] ; $00:31C5: $FA $0E $D8
...
.threeBytesObjectEnd
    ...
    ld   a, [bc]                                  ; $00:32C2: $0A
    sub  a, OBJECT_MACRO_F5                       ; $00:32C3: $D6 $F5
    ...
    inc  bc                                       ; $00:32CC: $03
    ; Handle the macro
    callsb ApplyOverworldObjectMacro              ; $00:32CD: $3E $24 $EA $00 $21 $CD $78 $75
...
label_350E::
    ...
    cp   ROOM_OW_EAGLE_TOWER                      ; $00:3514: $FE $0E
    ret  z                                        ; $00:3516: $C8
...
Func_358B::
    ...
    ld   a, [de]                                  ; $00:3593: $1A
    cp   $E1                                      ; $00:3594: $FE $E1
    jr   z, .label_35A0                           ; $00:3596: $28 $08
    cp   $E2                                      ; $00:3598: $FE $E2
    jr   z, .label_35A0                           ; $00:359A: $28 $04
    cp   $E3                                      ; $00:359C: $FE $E3
    jr   nz, .label_35BC                          ; $00:359E: $20 $1C
...
.label_35BC
    ld   [hl], a                                  ; $00:35BC: $77
    call label_35CB                               ; $00:35BD: $CD $CB $35
    inc  de                                       ; $00:35C0: $13
    inc  bc                                       ; $00:35C1: $03
    pop  hl                                       ; $00:35C2: $E1
    ld   a, [bc]                                  ; $00:35C3: $0A
...
label_35CB::
    ...
    ret  z                                        ; $00:35CD: $C8
    cp   $09                                      ; $00:35CE: $FE $09
    jr   nz, .label_35D9                          ; $00:35D0: $20 $07
    ldh  a, [hMapRoom]                            ; $00:35D2: $F0 $F6
    cp   ROOM_OW_GIANT_SKULL                      ; $00:35D4: $FE $97
    ret  nz                                       ; $00:35D6: $C0
    jr   label_35E8                               ; $00:35D7: $18 $0F

.label_35D9
    cp   $E1                                      ; $00:35D9: $FE $E1
    jr   nz, label_35E8                           ; $00:35DB: $20 $0B
    ldh  a, [hMapRoom]                            ; $00:35DD: $F0 $F6
    cp   ROOM_OW_EAGLE_TOWER                      ; $00:35DF: $FE $0E
    ret  z                                        ; $00:35E1: $C8
