...
.jr_14A7
    ...
    ret  c                                        ; $14B3: $D8
    callsb func_020_4C47                          ; $14B4: $3E $20 $EA $00 $21 $CD $47 $4C
...
.palettesskipEntityLoad
    ...
    ld   a, b                                     ; $22C0: $78
    ldh  [hScratchB], a                               ; $22C1: $E0 $E2
    ld   a, c                                     ; $22C3: $79
    ldh  [hScratchC], a                               ; $22C4: $E0 $E3
    ld   a, d                                     ; $22C6: $7A
    ldh  [hScratchD], a                           ; $22C7: $E0 $E4
    ld   a, e                                     ; $22C9: $7B
    ldh  [hScratchE], a                               ; $22CA: $E0 $E5
    ; Restore state
...
.horizontalRoomTransition
    ...
    ld   a, b                                     ; $22ED: $78
    ldh  [hScratchB], a                               ; $22EE: $E0 $E2
    ld   a, c                                     ; $22F0: $79
    ldh  [hScratchC], a                               ; $22F1: $E0 $E3
    ld   a, d                                     ; $22F3: $7A
    ldh  [hScratchD], a                           ; $22F4: $E0 $E4
    ld   a, e                                     ; $22F6: $7B
    ldh  [hScratchE], a                               ; $22F7: $E0 $E5
    ; Cleanup
