...
label_002_5877::
    ...
    nop                                           ; $5885: $00
    ld   [hl-], a                                 ; $5886: $32
    ld   bc, $800                            ; $5887: $01 $00 $08
    ld   [hl-], a                                 ; $588A: $32
    ld   hl, $0000                                ; $588B: $21 $00 $00
    ld   [hl-], a                                 ; $588E: $32
    ld   bc, $800                            ; $588F: $01 $00 $08
    ld   [hl-], a                                 ; $5892: $32
