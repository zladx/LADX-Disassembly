...
func_020_4898::
    push de                                       ; $4898: $D5
    ld   hl, wDrawCommand                         ; $4899: $21 $01 $D6
    ld   a, [wDrawCommandsSize]                   ; $489C: $FA $00 $D6
    ld   e, a                                     ; $489F: $5F
    add  $0A                                      ; $48A0: $C6 $0A
    ld   [wDrawCommandsSize], a                   ; $48A2: $EA $00 $D6
    ld   d, $00                                   ; $48A5: $16 $00
    add  hl, de                                   ; $48A7: $19
    pop  de                                       ; $48A8: $D1
    ldh  a, [hIntersectedObjectBGAddressHigh]     ; $48A9: $F0 $CF
    ld   [hl+], a                                 ; $48AB: $22
    ldh  a, [hIntersectedObjectBGAddressLow]      ; $48AC: $F0 $D0
    ld   [hl+], a                                 ; $48AE: $22
    ld   a, $81                                   ; $48AF: $3E $81
    ld   [hl+], a                                 ; $48B1: $22
    ld   a, [de]                                  ; $48B2: $1A
    ...
    ld   [hl+], a                                 ; $48BA: $22
    ldh  a, [hIntersectedObjectBGAddressLow]      ; $48BB: $F0 $D0
    inc  a                                        ; $48BD: $3C
    ld   [hl+], a                                 ; $48BE: $22
    ld   a, $81                                   ; $48BF: $3E $81
    ld   [hl+], a                                 ; $48C1: $22
...
func_020_48CA::
    ...
    ld   a, [hl]                                  ; $48EF: $7E
    cp   $53                                      ; $48F0: $FE $53
    jr   z, .jr_48FC                              ; $48F2: $28 $08

    cp   $55                                      ; $48F4: $FE $55
    jr   z, .jr_48FC                              ; $48F6: $28 $04
...
func_020_49F4::
    ...
    ld   [wDrawCommand.destinationLow], a         ; $49F7: $EA $02 $D6
    ld   a, [wBGUpdateRegionOriginHigh]           ; $49FA: $FA $26 $C1
    or   $98                                      ; $49FD: $F6 $98
    ld   [wDrawCommand.destinationHigh], a        ; $49FF: $EA $01 $D6
    ld   hl, Data_020_49F0                        ; $4A02: $21 $F0 $49
    add  hl, bc                                   ; $4A05: $09
    ld   a, [hl]                                  ; $4A06: $7E
    ld   [wDrawCommand.length], a                 ; $4A07: $EA $03 $D6
    ld   a, $00                                   ; $4A0A: $3E $00
    ld   [wDrawCommand.data + $14], a             ; $4A0C: $EA $18 $D6
    ld   a, $EE                                   ; $4A0F: $3E $EE
    ld   [wDrawCommand.data + $10], a             ; $4A11: $EA $14 $D6
    ld   [wDrawCommand.data + $11], a             ; $4A14: $EA $15 $D6
    ld   [wDrawCommand.data + $12], a             ; $4A17: $EA $16 $D6
    ld   [wDrawCommand.data + $13], a             ; $4A1A: $EA $17 $D6
    ld   b, HIGH(wDrawCommand.data)               ; $4A1D: $06 $D6
    ld   c, LOW(wDrawCommand.data)                ; $4A1F: $0E $04
    ret                                           ; $4A21: $C9

; CGB version
func_020_4A22::
    ld   a, [wBGUpdateRegionOriginLow]            ; $4A22: $FA $27 $C1
    ld   [wDrawCommand.destinationLow], a         ; $4A25: $EA $02 $D6
    ld   [wDrawCommandAlt.destinationLow], a      ; $4A28: $EA $92 $DC

    ld   a, [wBGUpdateRegionOriginHigh]           ; $4A2B: $FA $26 $C1
    or   $98                                      ; $4A2E: $F6 $98
    ld   [wDrawCommand.destinationHigh], a        ; $4A30: $EA $01 $D6
    ld   [wDrawCommandAlt.destinationHigh], a     ; $4A33: $EA $91 $DC

    ld   hl, Data_020_49F0                        ; $4A36: $21 $F0 $49
    add  hl, bc                                   ; $4A39: $09
    ld   a, [hl]                                  ; $4A3A: $7E
    ld   [wDrawCommand.length], a                 ; $4A3B: $EA $03 $D6
    ld   [wDrawCommandAlt.length], a              ; $4A3E: $EA $93 $DC

    ld   a, $00                                   ; $4A41: $3E $00
    ld   [wDrawCommand.data + $14], a             ; $4A43: $EA $18 $D6
    ld   [wDrawCommandAlt.data + $14], a          ; $4A46: $EA $A8 $DC

    ld   a, $EE                                   ; $4A49: $3E $EE
    ld   [wDrawCommand.data + $10], a             ; $4A4B: $EA $14 $D6
    ld   [wDrawCommand.data + $11], a             ; $4A4E: $EA $15 $D6
    ld   [wDrawCommand.data + $12], a             ; $4A51: $EA $16 $D6
    ld   [wDrawCommand.data + $13], a             ; $4A54: $EA $17 $D6
    ld   b, HIGH(wDrawCommand.data)               ; $4A57: $06 $D6
    ld   c, LOW(wDrawCommand.data)                ; $4A59: $0E $04
    ld   [wDrawCommandAlt.data + $10], a          ; $4A5B: $EA $A4 $DC
    ld   [wDrawCommandAlt.data + $11], a          ; $4A5E: $EA $A5 $DC
    ld   [wDrawCommandAlt.data + $12], a          ; $4A61: $EA $A6 $DC
    ld   [wDrawCommandAlt.data + $13], a          ; $4A64: $EA $A7 $DC
    ld   a, HIGH(wDrawCommandAlt.data)            ; $4A67: $3E $DC
ASSERT HIGH(wDrawCommandAlt.data) == HIGH(wDrawCommandAlt.data + $17)
    ...
    ld   a, LOW(wDrawCommandAlt.data)             ; $4A6D: $3E $94
    ldh  [hMultiPurposeC], a                      ; $4A6F: $E0 $E3
    ld   a, LOW(wDrawCommandAlt.data + $17)       ; $4A71: $3E $AB
...
.jr_4AD4
    ...
    and  a                                        ; $4AE1: $A7
    jr   z, .jr_4AEF                              ; $4AE2: $28 $0B

    ldh  a, [hMultiPurpose3]                      ; $4AE4: $F0 $DA
    and  a                                        ; $4AE6: $A7
    jr   z, .jr_4AEF                              ; $4AE7: $28 $06
...
.jr_4AEF
    ...
    and  a                                        ; $4B10: $A7
    jr   z, .ret_4B1E                             ; $4B11: $28 $0B

    ldh  a, [hMultiPurpose3]                      ; $4B13: $F0 $DA
    and  a                                        ; $4B15: $A7
    jr   z, .ret_4B1E                             ; $4B16: $28 $06
...
.label_020_4B9E
    ...
    add  hl, de                                   ; $4BB5: $19
    ld   [hl], d                                  ; $4BB6: $72
    ld   hl, wEntitiesPrivateCountdown3Table      ; $4BB7: $21 $80 $C4
    add  hl, de                                   ; $4BBA: $19
    ld   [hl], $03                                ; $4BBB: $36 $03
    ldh  a, [hIsSideScrolling]                    ; $4BBD: $F0 $F9
    and  a                                        ; $4BBF: $A7
    jr   nz, .jr_4BC8                             ; $4BC0: $20 $06
...
PositionTitleScreenSprites::
    ...
    ld   a, [wC17E]                               ; $526B: $FA $7E $C1
    inc  a                                        ; $526E: $3C
    cp   $10                                      ; $526F: $FE $10
    jr   c, .jr_5279                              ; $5271: $38 $06

    ld   a, $10                                   ; $5273: $3E $10
    ld   [wC17E], a                               ; $5275: $EA $7E $C1
    ret                                           ; $5278: $C9

.jr_5279
    ld   [wC17E], a                               ; $5279: $EA $7E $C1

jr_020_527C:
    ld   a, [wC17E]                               ; $527C: $FA $7E $C1
    ld   e, a                                     ; $527F: $5F
...
.loop_52A8
    ...
    ld   e, a                                     ; $52B8: $5F
    inc  a                                        ; $52B9: $3C
    ld   [wC17C], a                               ; $52BA: $EA $7C $C1
    cp   $3A                                      ; $52BD: $FE $3A
    jr   z, jr_020_52DC                           ; $52BF: $28 $1B

    cp   l                                        ; $52C1: $BD
    jr   c, .jr_52CE                              ; $52C2: $38 $0A
...
FadeOutMusic::
    ...
    cp   $03                                      ; $55D2: $FE $03
    jr   nz, .jr_55F0                             ; $55D4: $20 $1A

    ld   a, [wC16C]                               ; $55D6: $FA $6C $C1
    and  $03                                      ; $55D9: $E6 $03
    cp   $03                                      ; $55DB: $FE $03
    jr   nz, .jr_55F0                             ; $55DD: $20 $11

    ld   hl, hVolumeRight                         ; $55DF: $21 $A9 $FF
    ld   a, [hl]                                  ; $55E2: $7E
    inc  hl                                       ; $55E3: $23
    or   [hl]                                     ; $55E4: $B6
    jr   z, .jr_55F0                              ; $55E5: $28 $09
...
.jr_55F0
    ...
    ld   a, [hl]                                  ; $55F4: $7E
    and  $03                                      ; $55F5: $E6 $03
    jr   nz, ret_020_562E                         ; $55F7: $20 $35

    ld   hl, wTransitionSequenceCounter           ; $55F9: $21 $6B $C1
    ld   a, [hl]                                  ; $55FC: $7E
    cp   $04                                      ; $55FD: $FE $04
    jr   z, ret_020_562E                          ; $55FF: $28 $2D
...
InventoryLoad1Handler::
    ld   hl, wDrawCommand                         ; $59D0: $21 $01 $D6
...
; Load 32 bytes from 596A into DC91
    ld   hl, wDrawCommandAlt                      ; $59E3: $21 $91 $DC
...
; Set BC and E to point to the end of the "Palette Data?" (12 bytes) above
    ld   hl, wDrawCommandAlt                      ; $5A06: $21 $91 $DC
    ld   a, [wDrawCommandsAltSize]                ; $5A09: $FA $90 $DC
    ld   c, a                                     ; $5A0C: $4F
    ld   b, $00                                   ; $5A0D: $06 $00
    add  hl, bc                                   ; $5A0F: $09
...
.jr_5AAE
    ...
    push hl                                       ; $5AB5: $E5
    ld   b, $00                                   ; $5AB6: $06 $00
    ld   a, [wDrawCommandsAltSize]                ; $5AB8: $FA $90 $DC
    ld   c, a                                     ; $5ABB: $4F
    ld   hl, wDrawCommandAlt                      ; $5ABC: $21 $91 $DC
    add  hl, bc                                   ; $5ABF: $09
    ld   a, l                                     ; $5AC0: $7D
    sub  $11                                      ; $5AC1: $D6 $11
    ld   l, a                                     ; $5AC3: $6F
...
InventoryLoad2Handler::
    ...
    ld   [wDrawCommandAlt.destinationHigh], a     ; $5B11: $EA $91 $DC
    ld   [wDrawCommandAlt.data+1], a              ; $5B14: $EA $95 $DC
    ld   a, LOW($9C6E)                            ; $5B17: $3E $6E
    ld   [wDrawCommandAlt.destinationLow], a      ; $5B19: $EA $92 $DC
    ld   a, $8E                                   ; $5B1C: $3E $8E
    ld   [wDrawCommandAlt.data+2], a              ; $5B1E: $EA $96 $DC
    ld   a, $41                                   ; $5B21: $3E $41
    ld   [wDrawCommandAlt.length], a              ; $5B23: $EA $93 $DC
    ld   [wDrawCommandAlt.data+3], a              ; $5B26: $EA $97 $DC
    ldh  a, [hMultiPurpose0]                      ; $5B29: $F0 $D7
    ld   [wDrawCommandAlt.data], a                ; $5B2B: $EA $94 $DC
    ld   [wDrawCommandAlt.data+4], a              ; $5B2E: $EA $98 $DC
    xor  a                                        ; $5B31: $AF
    ld   [wDrawCommandAlt.data+5], a              ; $5B32: $EA $99 $DC

    ld   a, [wDrawCommandsAltSize]                ; $5B35: $FA $90 $DC
    add  $08                                      ; $5B38: $C6 $08
    ld   [wDrawCommandsAltSize], a                ; $5B3A: $EA $90 $DC
...
func_020_5BB9::
    ...
    ld   e, a                                     ; $5BBD: $5F
    ld   d, $00                                   ; $5BBE: $16 $00
    ld   hl, wDrawCommandAlt                      ; $5BC0: $21 $91 $DC
    add  hl, de                                   ; $5BC3: $19
    add  $05                                      ; $5BC4: $C6 $05
    ld   [wDrawCommandsAltSize], a                ; $5BC6: $EA $90 $DC
    push hl                                       ; $5BC9: $E5
    sla  c                                        ; $5BCA: $CB $21
    ...
    pop  hl                                       ; $5BE7: $E1
    cp   $06                                      ; $5BE8: $FE $06
    jr   nz, .jr_5BF9                             ; $5BEA: $20 $0D

    ld   a, [wPowerBraceletLevel]                 ; $5BEC: $FA $43 $DB
    cp   $02                                      ; $5BEF: $FE $02
    jr   nz, .jr_5BF9                             ; $5BF1: $20 $06
...
.jr_5BF9
    cp   $18                                      ; $5BF9: $FE $18
    jr   nz, .jr_5C0B                             ; $5BFB: $20 $0E

    ld   a, [wHasToadstool]                       ; $5BFD: $FA $4B $DB
    and  a                                        ; $5C00: $A7
    jr   z, .jr_5C0B                              ; $5C01: $28 $08
...
DrawInventorySlots::
    ...
    and  a                                        ; $5CAF: $A7
    jr   z, .jr_5CB5                              ; $5CB0: $28 $03

    call func_020_5BB9                            ; $5CB2: $CD $B9 $5B

.jr_5CB5
    ; de = start of the next draw command
    ld   a, [wDrawCommandsSize]                   ; $5CB5: $FA $00 $D6
    ld   e, a                                     ; $5CB8: $5F
    ld   d, $00                                   ; $5CB9: $16 $00

    ; hl = request start address
    ld   hl, wDrawCommand                         ; $5CBB: $21 $01 $D6
    add  hl, de                                   ; $5CBE: $19

    ; Increment the requests size by 0C
    add  $0C                                      ; $5CBF: $C6 $0C
    ld   [wDrawCommandsSize], a                   ; $5CC1: $EA $00 $D6
    push hl                                       ; $5CC4: $E5
...
.changeBGColumnPaletteAndExecuteDrawCommands                                 :
    ...
    ld   [wDrawCommandsAltSize], a                ; $5D46: $EA $90 $DC
    ld   [wDrawCommandAlt.destinationHigh], a     ; $5D49: $EA $91 $DC
...
moveInventoryCursor::
    ...
    jr   c, .jr_5F35                              ; $5F2C: $38 $07

    rla                                           ; $5F2E: $17
    ld   a, $00                                   ; $5F2F: $3E $00
    jr   nc, .jr_5F35                             ; $5F31: $30 $02
...
jr_020_5F38:
    ...
    jr   c, .jr_5F56                              ; $5F4D: $38 $07

    rla                                           ; $5F4F: $17
    ld   a, $00                                   ; $5F50: $3E $00
    jr   nc, .jr_5F56                             ; $5F52: $30 $02
...
jr_020_5F59:
    ...
    jr   z, .jr_5F69                              ; $5F5D: $28 $0A

    ld   a, [wOcarinaMenuOpen]                    ; $5F5F: $FA $B5 $C1
    and  a                                        ; $5F62: $A7
    jr   nz, .jr_5F69                             ; $5F63: $20 $04
...
jr_020_6141:
    ...
    and  a                                        ; $6144: $A7
    jp   z, ret_020_6214                          ; $6145: $CA $14 $62
...
.jr_6226
    ...
    and  $20                                      ; $623C: $E6 $20
    jr   z, .jr_624D                              ; $623E: $28 $0D

    ld   a, [wD46B]                               ; $6240: $FA $6B $D4
    and  $38                                      ; $6243: $E6 $38
    cp   $20                                      ; $6245: $FE $20
    jr   nc, .jr_624D                             ; $6247: $30 $04
...
.jr_624D
    ...
    and  $10                                      ; $6250: $E6 $10
    jr   z, .jr_6261                              ; $6252: $28 $0D

    ld   a, [wD46B]                               ; $6254: $FA $6B $D4
    and  $07                                      ; $6257: $E6 $07
    cp   $04                                      ; $6259: $FE $04
    jr   c, .jr_6261                              ; $625B: $38 $04
...
func_020_6AF5::
    ...
    and  $1F                                      ; $6B0A: $E6 $1F
    cp   b                                        ; $6B0C: $B8
    jr   c, .jr_6B17                              ; $6B0D: $38 $08

    jr   z, .jr_6B17                              ; $6B0F: $28 $06

    sub  c                                        ; $6B11: $91
    jr   c, .jr_6B17                              ; $6B12: $38 $03
...
jr_020_6B18:
    ...
    pop  af                                       ; $6B37: $F1
    cp   b                                        ; $6B38: $B8
    jr   c, .jr_6B43                              ; $6B39: $38 $08

    jr   z, .jr_6B43                              ; $6B3B: $28 $06

    sub  c                                        ; $6B3D: $91
    jr   c, .jr_6B43                              ; $6B3E: $38 $03
...
jr_020_6B44:
    ...
    and  $7C                                      ; $6B4E: $E6 $7C
    cp   b                                        ; $6B50: $B8
    jr   c, .jr_6B5B                              ; $6B51: $38 $08

    jr   z, .jr_6B5B                              ; $6B53: $28 $06

    sub  c                                        ; $6B55: $91
    jr   c, .jr_6B5B                              ; $6B56: $38 $03
...
ApplyFadeToWhite_GBC::
    ...
    cp   $20                                      ; $6CAA: $FE $20
    jr   z, ret_020_6D0D                          ; $6CAC: $28 $5F

    push af                                       ; $6CAE: $F5
    and  $02                                      ; $6CAF: $E6 $02
    jr   nz, .jr_6CB5                             ; $6CB1: $20 $02
...
.jr_6CB5
    ...
    jr   ret_020_6D0D                             ; $6CF8: $18 $13

.jr_6CFA
    ld   a, [wC3CA]                               ; $6CFA: $FA $CA $C3
    dec  a                                        ; $6CFD: $3D
    and  $03                                      ; $6CFE: $E6 $03
    jr   nz, ret_020_6D0D                         ; $6D00: $20 $0B
...
func_020_6D0E::
    ...
    dec  a                                        ; $6D0F: $3D
    cp   $04                                      ; $6D10: $FE $04
    jr   c, ret_020_6D51                          ; $6D12: $38 $3D

    ldh  a, [hFrameCounter]                       ; $6D14: $F0 $E7
    and  $01                                      ; $6D16: $E6 $01
    jr   z, .jr_6D1E                              ; $6D18: $28 $04
...
IndoorsTilesetsTable::
    db   W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_00, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_01, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_05, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_09, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_05, W_TILESET_DUNGEONS2_05, W_TILESET_DUNGEONS2_05, W_TILESET_NO_UPDATE
    db   W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_00, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_02, W_TILESET_DUNGEONS2_01, W_TILESET_DUNGEONS2_01, W_TILESET_DUNGEONS2_01, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE
    db   W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_00, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_00, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_00, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_02, W_TILESET_DUNGEONS2_00, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_0E
    db   W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_01, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE
    db   W_TILESET_DUNGEONS2_02, W_TILESET_DUNGEONS2_02, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_02, W_TILESET_DUNGEONS2_02, W_TILESET_DUNGEONS2_09, W_TILESET_DUNGEONS2_09, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_02, W_TILESET_DUNGEONS2_02, W_TILESET_DUNGEONS2_09, W_TILESET_DUNGEONS2_02, W_TILESET_DUNGEONS2_09, W_TILESET_DUNGEONS2_09, W_TILESET_DUNGEONS2_09, W_TILESET_DUNGEONS2_09
    db   W_TILESET_DUNGEONS2_09, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_01, W_TILESET_DUNGEONS2_01, W_TILESET_DUNGEONS2_05, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_0A, W_TILESET_DUNGEONS2_0A, W_TILESET_DUNGEONS2_0A, W_TILESET_DUNGEONS2_0A, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_00
    db   W_TILESET_DUNGEONS2_09, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_09, W_TILESET_DUNGEONS2_09, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_09, W_TILESET_DUNGEONS2_09, W_TILESET_DUNGEONS2_09, W_TILESET_DUNGEONS2_09, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_00, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_02, W_TILESET_NO_UPDATE
    db   W_TILESET_DUNGEONS2_09, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_00, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_00, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_01, W_TILESET_DUNGEONS2_05, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_00
    db   W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_05, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_06, W_TILESET_DUNGEONS2_07, W_TILESET_DUNGEONS2_07, W_TILESET_DUNGEONS2_07, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_06, W_TILESET_DUNGEONS2_06, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE
    db   W_TILESET_DUNGEONS2_09, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_07, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_07, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_07, W_TILESET_DUNGEONS2_05, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_05, W_TILESET_DUNGEONS2_05, W_TILESET_DUNGEONS2_05
    db   W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_01, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_19, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE
    db   W_TILESET_DUNGEONS2_03, W_TILESET_DUNGEONS2_0E, W_TILESET_DUNGEONS2_03, W_TILESET_DUNGEONS2_0E, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_0E, W_TILESET_DUNGEONS2_0E, W_TILESET_DUNGEONS2_0E, W_TILESET_DUNGEONS2_0E, W_TILESET_DUNGEONS2_0E, W_TILESET_DUNGEONS2_0E, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_0E, W_TILESET_DUNGEONS2_0E, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_0E
    db   W_TILESET_DUNGEONS2_0E, W_TILESET_DUNGEONS2_0E, W_TILESET_DUNGEONS2_0E, W_TILESET_DUNGEONS2_09, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_0E, W_TILESET_DUNGEONS2_09, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_0E, W_TILESET_DUNGEONS2_09, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_0E, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_02, W_TILESET_DUNGEONS2_0E
    db   W_TILESET_DUNGEONS2_0E, W_TILESET_DUNGEONS2_0E, W_TILESET_DUNGEONS2_02, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_01, W_TILESET_DUNGEONS2_01, W_TILESET_DUNGEONS2_01, W_TILESET_DUNGEONS2_09, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_00
    db   W_TILESET_DUNGEONS2_0F, W_TILESET_DUNGEONS2_0F, W_TILESET_DUNGEONS2_0F, W_TILESET_DUNGEONS2_08, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_03, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_00
    db   W_TILESET_DUNGEONS2_03, W_TILESET_DUNGEONS2_03, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_19, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_08, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_03, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_08, W_TILESET_DUNGEONS2_19, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_05, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_00

    db   W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_03, W_TILESET_DUNGEONS2_03, W_TILESET_DUNGEONS2_03, W_TILESET_DUNGEONS2_03, W_TILESET_DUNGEONS2_03, W_TILESET_DUNGEONS2_03, W_TILESET_DUNGEONS2_03, W_TILESET_DUNGEONS2_03, W_TILESET_DUNGEONS2_03, W_TILESET_DUNGEONS2_03, W_TILESET_DUNGEONS2_03, W_TILESET_DUNGEONS2_03, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_01, W_TILESET_NO_UPDATE
    db   W_TILESET_DUNGEONS2_03, W_TILESET_DUNGEONS2_03, W_TILESET_DUNGEONS2_03, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_03, W_TILESET_DUNGEONS2_03, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_0B, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_03, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_07, W_TILESET_DUNGEONS2_07, W_TILESET_NO_UPDATE
    db   W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_06, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_00, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_0E, W_TILESET_DUNGEONS2_0E, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_0E, W_TILESET_DUNGEONS2_0E, W_TILESET_DUNGEONS2_00
    db   W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_00, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_00, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_17, W_TILESET_DUNGEONS2_17, W_TILESET_DUNGEONS2_17, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_03, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE
    db   W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_0A, W_TILESET_DUNGEONS2_0A, W_TILESET_DUNGEONS2_0A, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_0A, W_TILESET_DUNGEONS2_0A, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_0B, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_0D, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE
    db   W_TILESET_DUNGEONS2_0A, W_TILESET_DUNGEONS2_0A, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_00, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_09, W_TILESET_DUNGEONS2_01, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_00
    db   W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_01
    db   W_TILESET_DUNGEONS2_0C, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_WINDFISH_FLOOR, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_01
    db   W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_05, W_TILESET_DUNGEONS2_05, W_TILESET_DUNGEONS2_05, W_TILESET_DUNGEONS2_01
    db   W_TILESET_DUNGEONS2_05, W_TILESET_DUNGEONS2_05, W_TILESET_DUNGEONS2_05, W_TILESET_DUNGEONS2_05, W_TILESET_DUNGEONS2_05, W_TILESET_DUNGEONS2_05, W_TILESET_DUNGEONS2_05, W_TILESET_DUNGEONS2_05, W_TILESET_DUNGEONS2_05, W_TILESET_DUNGEONS2_04, W_TILESET_DUNGEONS2_05, W_TILESET_DUNGEONS2_04, W_TILESET_DUNGEONS2_04, W_TILESET_DUNGEONS2_04, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_08
    db   W_TILESET_DUNGEONS2_04, W_TILESET_DUNGEONS2_04, W_TILESET_DUNGEONS2_08, W_TILESET_DUNGEONS2_08, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_08, W_TILESET_DUNGEONS2_08, W_TILESET_DUNGEONS2_08, W_TILESET_DUNGEONS2_08, W_TILESET_DUNGEONS2_08, W_TILESET_DUNGEONS2_08, W_TILESET_DUNGEONS2_05, W_TILESET_DUNGEONS2_05, W_TILESET_DUNGEONS2_08, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C
    db   W_TILESET_DUNGEONS2_08, W_TILESET_DUNGEONS2_04, W_TILESET_DUNGEONS2_05, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_04, W_TILESET_DUNGEONS2_08, W_TILESET_DUNGEONS2_05, W_TILESET_DUNGEONS2_05, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_05, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C
    db   W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_03, W_TILESET_DUNGEONS2_03, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_03, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_08, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_04, W_TILESET_DUNGEONS2_04, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C
    db   W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C, W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_01, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_01, W_TILESET_DUNGEONS2_01, W_TILESET_DUNGEONS2_08, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_08, W_TILESET_DUNGEONS2_08, W_TILESET_DUNGEONS2_08, W_TILESET_DUNGEONS2_08, W_TILESET_DUNGEONS2_08, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C
    db   W_TILESET_NO_UPDATE, W_TILESET_DUNGEONS2_08, W_TILESET_DUNGEONS2_08, W_TILESET_DUNGEONS2_04, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_08, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C
    db   W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_0C, W_TILESET_DUNGEONS2_18, W_TILESET_DUNGEONS2_05, W_TILESET_DUNGEONS2_00, W_TILESET_DUNGEONS2_08, W_TILESET_DUNGEONS2_00
...
._00  db   $A4, $FF, $FF, $FF ; $73F3
._01  db   $A4, $8E, $7C, $C8
._02  db   $A4, $4A, $7C, $93 ; $73FB
._03  db   $A4, $E5, $FF, $4E
._04  db   $A4, $91, $83, $A2 ; $7403
._05  db   $A4, $42, $8A, $FF
._06  db   $A4, $42, $83, $A2 ; $740B
._07  db   $A4, $81, $E3, $A2
._08  db   $A4, $E5, $E3, $FF ; $7413
._09  db   $A4, $E5, $43, $E7
._0A  db   $A4, $E5, $E6, $FF ; $741B
._0B  db   $A4, $E5, $E6, $E7
._0C  db   $A4, $E5, $43, $A4 ; $7423
._0D  db   $A4, $8E, $83, $A4
._0E  db   $A4, $4A, $83, $40 ; $742B
._0F  db   $A4, $E5, $4C, $E7
._10  db   $A4, $4D, $83, $FF ; $7433
._11  db   $A4, $42, $92, $5A
._12  db   $A4, $61, $92, $67 ; $743B
._13  db   $A4, $E5, $FF, $FF
._14  db   $A4, $E3, $8B, $FF ; $7443
._15  db   $A4, $E3, $83, $76
._16  db   $A4, $81, $79, $76 ; $744B
._17  db   $A4, $61, $8B, $FF
._18  db   $A4, $6C, $8B, $6B ; $7453
._19  db   $A4, $FF, $8B, $FF
._1A  db   $A4, $E3, $8B, $A2 ; $745B
._1B  db   $A4, $E5, $FF, $FF
._1C  db   $A4, $4A, $8F, $6D ; $7463
._1D  db   $A4, $81, $6E, $52
._1E  db   $A4, $4D, $43, $A2 ; $746B
._1F  db   $A4, $61, $79, $76
._20  db   $A4, $C6, $7C, $41 ; $7473
._21  db   $A4, $C5, $6E, $6F
._22  db   $A4, $C5, $FF, $70 ; $747B
._23  db   $A4, $61, $FF, $71
._24  db   $A4, $61, $FF, $72 ; $7483
._25  db   $A4, $61, $79, $73
._26  db   $A4, $61, $79, $FF ; $748B
._27  db   $A4, $E3, $79, $76
._28  db   $A4, $42, $82, $A2 ; $7493
._29  db   $A4, $42, $FF, $82
._2A  db   $A4, $61, $78, $A2 ; $749B
._2B  db   $A4, $81, $8F, $E7
._2C  db   $A4, $E3, $8B, $8C ; $74A3
._2D  db   $A4, $87, $78, $A2
._2E  db   $A4, $6C, $7C, $C8 ; $74AB
._2F  db   $A4, $C4, $E6, $CF
._30  db   $A4, $FF, $6E, $6F ; $74B3
._31  db   $A4, $FF, $E6, $CF
._32  db   $A4, $FF, $83, $FF ; $74BB
._33  db   $A4, $C4, $79, $76
._34  db   $A4, $C4, $FF, $FF ; $74C3
._35  db   $A4, $C4, $43, $CF
._36  db   $A4, $FF, $79, $FF ; $74CB
._37  db   $A4, $FF, $FF, $A2
._38  db   $A4, $61, $79, $A2 ; $74D3
._39  db   $A4, $E5, $FF, $FF
._3A  db   $A4, $E5, $82, $A2 ; $74DB
._3B  db   $A4, $E3, $83, $A2
._3C  db   $A4, $91, $83, $76 ; $74E3
._3D  db   $A4, $FF, $7C, $A2
._3E  db   $A4, $E3, $8B, $A2 ; $74EB
._3F  db   $A4, $E3, $FF, $76
._40  db   $A4, $FF, $E6, $A2 ; $74F3
._41  db   $A4, $FF, $7C, $A2
._42  db   $A4, $81, $E3, $D4 ; $74FB
._43  db   $A4, $E5, $E6, $DC
._44  db   $A4, $87, $D6, $D7 ; $7503
._45  db   $A4, $50, $51, $A2
._46  db   $A4, $6C, $8F, $A2 ; $750B
._47  db   $A4, $4A, $83, $A2
._48  db   $A4, $4A, $83, $FF ; $7513
._49  db   $A4, $81, $8F, $76
._4A  db   $A4, $E3, $8B, $FF ; $751B
._4B  db   $A4, $FF, $79, $FF
._4C  db   $A4, $81, $6E, $FF ; $7523
._4D  db   $A4, $81, $6E, $8C
._4E  db   $A4, $87, $8F, $76 ; $752B
._4F  db   $A4, $FF, $8F, $FF
._50  db   $A4, $87, $FF, $FF ; $7533
._51  db   $A4, $87, $83, $76
._52  db   $A4, $87, $83, $98 ; $753B
._53  db   $A4, $FF, $79, $76
._54  db   $A4, $E3, $83, $A2 ; $7543
._55  db   $A4, $61, $79, $93
._56  db   $A4, $FF, $79, $93 ; $754B
._57  db   $A4, $C4, $79, $FF
._58  db   $A4, $FF, $92, $5A ; $7553
._59  db   $A4, $61, $92, $8C
._5A  db   $A4, $42, $92, $FF ; $755B
._5B  db   $A4, $61, $FF, $FF
._5C  db   $A4, $61, $FF, $8C ; $7563
._5D  db   $A4, $FF, $83, $93
._5E  db   $A4, $61, $8B, $FF ; $756B
._5F  db   $A4, $E3, $FF, $FF
._60  db   $A4, $61, $FF, $67 ; $7573
._61  db   $A4, $FF, $FF, $A2
._62  db   $A4, $87, $E3, $93 ; $757B
._63  db   $A4, $87, $FF, $FF
._64  db   $A4, $87, $92, $5A ; $7583
._65  db   $A4, $C6, $9C, $98
._66  db   $A4, $C6, $9C, $FF ; $758B
._67  db   $A4, $FF, $9C, $93
._68  db   $A4, $81, $FF, $FF ; $7593
._69  db   $A4, $FF, $9C, $98
._6A  db   $A4, $FF, $83, $FF ; $759B
._6B  db   $A4, $81, $FF, $93
._6C  db   $A4, $81, $9C, $93 ; $75A3
._6D  db   $A4, $44, $9C, $98
._6E  db   $A4, $91, $78, $A2 ; $75AB
._6F  db   $A4, $FF, $78, $A2
._70  db   $A4, $61, $FF, $A2 ; $75B3
._71  db   $A4, $FF, $79, $A2
._72  db   $A4, $61, $83, $FF ; $75BB
._73  db   $A4, $FF, $83, $A2
._74  db   $A4, $FF, $7C, $FF ; $75C3
._75  db   $A4, $E3, $8B, $A2
._76  db   $A4, $E3, $83, $FF ; $75CB
._77  db   $A4, $FF, $83, $76
._78  db   $A4, $61, $83, $FF ; $75D3
._79  db   $A4, $61, $FF, $76
._7A  db   $A4, $61, $FF, $A2 ; $75DB
._7B  db   $A4, $81, $6E, $FF
._7C  db   $A4, $81, $FF, $8C ; $75E3
._7D  db   $A4, $4A, $7C, $93
._7E  db   $A4, $91, $7C, $A2 ; $75EB
._7F  db   $A4, $4D, $7C, $FF
._80  db   $A4, $FF, $FF, $FF ; $75F3
._81  db   $A4, $FF, $FF, $FF
._82  db   $A4, $FF, $FF, $FF ; $75FB
._83  db   $A4, $FF, $FF, $FF
._84  db   $A4, $FF, $FF, $FF ; $7603
._85  db   $A4, $FF, $FF, $FF
._86  db   $A4, $FF, $FF, $FF ; $760B
._87  db   $A4, $FF, $FF, $FF
._88  db   $A4, $FF, $FF, $FF ; $7613
._89  db   $A4, $FF, $FF, $FF
._8A  db   $A4, $FF, $FF, $FF ; $761B
._8B  db   $A4, $FF, $FF, $FF
._8C  db   $A4, $FF, $FF, $FF ; $7623
._8D  db   $A4, $FF, $FF, $FF
._8E  db   $A4, $FF, $FF, $FF ; $762B
._8F  db   $A4, $FF, $FF, $FF
._90  db   $A4, $81, $8F, $D4 ; $7633
._91  db   $A4, $81, $79, $FF
...
._00  db   $FF, $FF, $FF, $FF ; $763B
._01  db   $90, $91, $92, $98
._02  db   $90, $91, $AB, $FF ; $7643
._03  db   $90, $91, $92, $93
._04  db   $90, $91, $94, $9F ; $764B
._05  db   $90, $91, $B0, $B1
._06  db   $90, $91, $9C, $93 ; $7653
._07  db   $90, $91, $97, $9B
._08  db   $FF, $FF, $B6, $B7 ; $765B
._09  db   $A4, $4C, $49, $46
._0A  db   $A4, $FF, $45, $6D ; $7663
._0B  db   $A4, $FF, $47, $48
._0C  db   $A4, $FF, $4C, $4B ; $766B
._0D  db   $90, $91, $96, $FF
._0E  db   $FF, $FF, $4F, $50 ; $7673
._0F  db   $FF, $FF, $4F, $51
._10  db   $A4, $87, $84, $89 ; $767B
._11  db   $A4, $FF, $88, $C7
._12  db   $A0, $A1, $84, $83 ; $7683
._13  db   $90, $91, $54, $A6
._14  db   $90, $91, $97, $93 ; $768B
._15  db   $90, $91, $AA, $FF
._16  db   $90, $91, $B4, $B5 ; $7693
._17  db   $90, $91, $9C, $9E
._18  db   $90, $91, $9C, $9D ; $769B
._19  db   $68, $91, $56, $60
._1A  db   $AC, $AD, $AE, $AF ; $76A3
._1B  db   $90, $91, $58, $9B
._1C  db   $90, $91, $A6, $59 ; $76AB
._1D  db   $FF, $FF, $B8, $B9
._1E  db   $90, $91, $62, $63 ; $76B3
._1F  db   $90, $91, $A8, $9F
._20  db   $A4, $DF, $A3, $FF ; $76BB
._21  db   $90, $91, $92, $9A
._22  db   $A4, $5B, $5C, $FF ; $76C3
._23  db   $A6, $91, $97, $9B
._24  db   $90, $91, $9C, $60 ; $76CB
._25  db   $FF, $FF, $B2, $B3
._26  db   $A6, $91, $57, $FF ; $76D3
._27  db   $A6, $91, $95, $98
._28  db   $A6, $91, $5E, $60 ; $76DB
._29  db   $A6, $91, $AA, $93
._2A  db   $A6, $91, $58, $99 ; $76E3
._2B  db   $90, $91, $95, $93
._2C  db   $5F, $91, $55, $99 ; $76EB
._2D  db   $66, $91, $5E, $59
._2E  db   $66, $91, $54, $59 ; $76F3
._2F  db   $8D, $8E, $8F, $6A
._30  db   $68, $91, $9B, $60 ; $76FB
._31  db   $68, $91, $94, $9F
._32  db   $68, $91, $9C, $60 ; $7703
._33  db   $5F, $65, $5D, $64
._34  db   $FF, $91, $55, $FF ; $770B
._35  db   $5F, $91, $95, $99
._36  db   $5F, $91, $5E, $99 ; $7713
._37  db   $5F, $91, $A9, $FF
._38  db   $5F, $91, $94, $9F ; $771B
._39  db   $90, $91, $55, $93
._3A  db   $A4, $FF, $7C, $FF ; $7723
._3B  db   $BC, $BD, $BE, $BF
._3C  db   $A6, $91, $9C, $9D ; $772B
._3D  db   $FF, $D5, $78, $53
._3E  db   $90, $91, $FF, $FF ; $7733
._3F  db   $5F, $91, $55, $98
._40  db   $A4, $FF, $FF, $69 ; $773B
._41  db   $A4, $FF, $4C, $74
._42  db   $A0, $A1, $75, $4E ; $7743
._43  db   $A4, $7D, $7E, $7F
._44  db   $A4, $FF, $FF, $C7 ; $774B
._45  db   $C0, $C1, $C2, $C3
._46  db   $A4, $CC, $CD, $CE ; $7753
._47  db   $A4, $C9, $CA, $CB
._48  db   $A4, $D1, $D2, $6A ; $775B
._49  db   $DD, $E5, $D3, $DD
._4A  db   $DD, $FF, $DE, $FF ; $7763
._4B  db   $A4, $8D, $FF, $FF
._4C  db   $FF, $DF, $49, $FF ; $776B
._4D  db   $FF, $C4, $FF, $FF
._4E  db   $A4, $80, $7C, $A5 ; $7773
._4F  db   $FF, $FF, $FF, $FF
._50  db   $FF, $FF, $BA, $BB ; $777B
._51  db   $77, $91, $A7, $FF
._52  db   $7B, $91, $7A, $AB ; $7783
._53  db   $7B, $91, $57, $99
._54  db   $77, $91, $7A, $AA ; $778B
._55  db   $7B, $91, $54, $99
._56  db   $7B, $91, $56, $FF ; $7793
._57  db   $77, $91, $54, $99
._58  db   $7B, $91, $FF, $FF ; $779B
._59  db   $5F, $91, $9D, $99
._5A  db   $7B, $91, $96, $99 ; $77A3
._5B  db   $7B, $91, $7A, $99
._5C  db   $77, $91, $7A, $99 ; $77AB
._5D  db   $77, $91, $96, $99
._5E  db   $5F, $91, $55, $93 ; $77B3
._5F  db   $FF, $91, $95, $93
._60  db   $90, $91, $55, $93 ; $77BB
._61  db   $A6, $91, $95, $60
._62  db   $A6, $91, $95, $99 ; $77C3
._63  db   $5F, $D9, $DA, $DB
._64  db   $5F, $D9, $DA, $64 ; $77CB
._65  db   $FF, $91, $90, $76
._66  db   $FF, $91, $90, $98 ; $77D3
._67  db   $FF, $4A, $90, $76
._68  db   $5F, $FF, $FF, $FF ; $77DB
._69  db   $FF, $FF, $FF, $FF
._6A  db   $FF, $FF, $FF, $FF ; $77E3
._6B  db   $FF, $FF, $FF, $FF
._6C  db   $FF, $FF, $FF, $FF ; $77EB
._6D  db   $FF, $91, $90, $A6
._6E  db   $A4, $FF, $FF, $F4 ; $77F3
._6F  db   $E8, $E9, $EA, $EB
._70  db   $FF, $FF, $FF, $FF ; $77FB
._71  db   $FF, $FF, $FF, $FF
._72  db   $FF, $FF, $FF, $FF ; $7803
._73  db   $FF, $FF, $FF, $FF
._74  db   $FF, $FF, $FF, $FF ; $780B
._75  db   $FF, $FF, $FF, $FF
._76  db   $FF, $FF, $FF, $FF ; $7813
._77  db   $FF, $FF, $FF, $FF
._78  db   $FF, $FF, $FF, $FF ; $781B
._79  db   $FF, $FF, $FF, $FF
._7A  db   $FF, $FF, $FF, $FF ; $7823
._7B  db   $FF, $FF, $FF, $FF
._7C  db   $44, $A1, $75, $4E ; $782B
._7D  db   $FF, $61, $FF, $FF
._7E  db   $A4, $FF, $86, $FF ; $7833
._7F  db   $A4, $FF, $8B, $FF
._80  db   $A4, $4D, $FF, $FF ; $783B
...
jr_020_7D97:
    ...
    ld   a, [hl]                                  ; $7D9B: $7E
    and  $1F                                      ; $7D9C: $E6 $1F
    jr   z, .jr_7DA4                              ; $7D9E: $28 $04

    sub  c                                        ; $7DA0: $91
    jr   nc, .jr_7DA4                             ; $7DA1: $30 $01
...
.jr_7DA4
    ...
    or   b                                        ; $7DB4: $B0
    and  $3E                                      ; $7DB5: $E6 $3E
    jr   z, .jr_7DBD                              ; $7DB7: $28 $04

    sub  c                                        ; $7DB9: $91
    jr   nc, .jr_7DBD                             ; $7DBA: $30 $01
...
.jr_7DBD
    ...
    ld   a, [hl]                                  ; $7DC2: $7E
    and  $7C                                      ; $7DC3: $E6 $7C
    jr   z, .jr_7DCB                              ; $7DC5: $28 $04

    sub  c                                        ; $7DC7: $91
    jr   nc, .jr_7DCB                             ; $7DC8: $30 $01
