...
include "data/rooms_gfx/floor_wall_tables.asm"
...
include "data/palettes/inventory.asm"
...
include "data/palettes/instrument_cycle.asm"
...
TilesetTables::
include "data/rooms_gfx/overworld_tileset_table.asm"
include "data/rooms_gfx/indoors_tileset_table.asm"

include "data/rooms_gfx/room_spritesheet_tables.asm"
