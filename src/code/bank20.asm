...
jr_020_4064:
    ...
    ld   e, d                                     ; $40A0: $5A
    inc  bc                                       ; $40A1: $03
    call c, $0359                                 ; $40A2: $DC $59 $03
    ld   a, l                                     ; $40A5: $7D
    ld   h, b                                     ; $40A6: $60
    inc  bc                                       ; $40A7: $03
    jp   nz, WaitForNextFrame                     ; $40A8: $C2 $5F $03
...
jr_020_4100:
    ...
    ld   d, l                                     ; $4136: $55
    dec  b                                        ; $4137: $05
    jr   c, jr_020_41AE                           ; $4138: $38 $74

    dec  d                                        ; $413A: $15
    adc  $53                                      ; $413B: $CE $53
    jr   jr_020_419D                              ; $413D: $18 $5E

    ld   d, e                                     ; $413F: $53
    dec  b                                        ; $4140: $05
    add  l                                        ; $4141: $85
    ld   e, l                                     ; $4142: $5D
    jr   jr_020_4169                              ; $4143: $18 $24
...
jr_020_422A:
    ...
    ld   e, c                                     ; $422B: $59
    ld   [hl], a                                  ; $422C: $77
    jr   jr_020_4250                              ; $422D: $18 $21

    ld   a, b                                     ; $422F: $78
    jr   jr_020_4254                              ; $4230: $18 $22
...
jr_020_4236:
    jr   jr_020_4234                              ; $4236: $18 $FC

    ld   l, c                                     ; $4238: $69
    jr   jr_020_4207                              ; $4239: $18 $CC

    ld   h, h                                     ; $423B: $64
    jr   jr_020_41CB                              ; $423C: $18 $8D

    ld   h, e                                     ; $423E: $63
    jr   jr_020_41D3                              ; $423F: $18 $92

    ld   h, d                                     ; $4241: $62
    jr   jr_020_41CE                              ; $4242: $18 $8A

    ld   h, c                                     ; $4244: $61
    jr   jr_020_421E                              ; $4245: $18 $D7

    ld   e, [hl]                                  ; $4247: $5E
    jr   jr_020_424A                              ; $4248: $18 $00

jr_020_424A:
    ld   b, b                                     ; $424A: $40
    jr   jr_020_424E                              ; $424B: $18 $01

    ld   d, l                                     ; $424D: $55

jr_020_424E:
    jr   jr_020_41FB                              ; $424E: $18 $AB
...
jr_020_4254:
    ...
    nop                                           ; $4255: $00
    ld   b, l                                     ; $4256: $45
    jr   jr_020_41FF                              ; $4257: $18 $A6

    ld   d, d                                     ; $4259: $52
    jr   jr_020_4254                              ; $425A: $18 $F8

    ld   a, [hl]                                  ; $425C: $7E
    dec  b                                        ; $425D: $05
    db   $dd                                      ; $425E: $DD
    ld   c, [hl]                                  ; $425F: $4E
    jr   jr_020_4236                              ; $4260: $18 $D4

    ld   c, c                                     ; $4262: $49
    jr   jr_020_4220                              ; $4263: $18 $BB

    ld   b, h                                     ; $4265: $44
    dec  d                                        ; $4266: $15
    ld   de, label_196F                           ; $4267: $11 $6F $19
    jr   c, jr_020_42B5                           ; $426A: $38 $49

    jr   jr_020_422A                              ; $426C: $18 $BC
    ...
    ld   l, e                                     ; $4276: $6B
    ld   d, d                                     ; $4277: $52
    jr   jr_020_4252                              ; $4278: $18 $D8

    ld   d, c                                     ; $427A: $51
    jr   jr_020_4295                              ; $427B: $18 $18

    ld   e, [hl]                                  ; $427D: $5E
    add  hl, de                                   ; $427E: $19
    call c, $1959                                 ; $427F: $DC $59 $19
    db   $dd                                      ; $4282: $DD
    ld   e, b                                     ; $4283: $58
    add  hl, de                                   ; $4284: $19
    push bc                                       ; $4285: $C5
...
jr_020_445A:
    ...
    nop                                           ; $452B: $00
    nop                                           ; $452C: $00
    call z, func_020_4856                         ; $452D: $CC $56 $48
    ld   h, a                                     ; $4530: $67
    ld   [hl], $63                                ; $4531: $36 $63
...
jr_020_4669:
    ...
    dec  l                                        ; $466C: $2D
    dec  l                                        ; $466D: $2D
    jr   z, jr_020_469C                           ; $466E: $28 $2C

    dec  l                                        ; $4670: $2D
    dec  l                                        ; $4671: $2D
    ldh  a, [$FF28]                               ; $4672: $F0 $28
    ld   [hl], e                                  ; $4674: $73
    ld   l, $69                                   ; $4675: $2E $69
    inc  b                                        ; $4677: $04
    jp   hl                                       ; $4678: $E9
    ...
    ld   e, [hl]                                  ; $467C: $5E
    ld   l, $FC                                   ; $467D: $2E $FC
    jr   c, jr_020_4669                           ; $467F: $38 $E8

    jr   z, jr_020_46FC                           ; $4681: $28 $79
...
jr_020_47C2:
    ...
    ld   c, a                                     ; $47F9: $4F
    ld   hl, $47CB                                ; $47FA: $21 $CB $47
    ld   a, b                                     ; $47FD: $78
    and  a                                        ; $47FE: $A7
    jr   z, jr_020_4804                           ; $47FF: $28 $03

    ld   hl, $47E1                                ; $4801: $21 $E1 $47
...
jr_020_527C:
    ...
    ld   e, a                                     ; $527F: $5F
    ld   hl, $5246                                ; $5280: $21 $46 $52
    add  hl, de                                   ; $5283: $19
    ld   a, [hl]                                  ; $5284: $7E
    ldh  [hScratchA], a                           ; $5285: $E0 $D7
    sla  e                                        ; $5287: $CB $23
    ld   hl, $5224                                ; $5289: $21 $24 $52
    add  hl, de                                   ; $528C: $19
    ld   a, [hl+]                                 ; $528D: $2A
    ld   b, [hl]                                  ; $528E: $46
    ld   c, a                                     ; $528F: $4F
