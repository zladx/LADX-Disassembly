...
LoadRoomObjectsAttributes::
    ...
    cp   ROOM_OW_EAGLE_TOWER                      ; $20:6DB6: $FE $0E
    jr   nz, .jr_020_6DC6                         ; $20:6DB8: $20 $0C

    ld   a, [wOverworldRoomStatus + ROOM_OW_EAGLE_TOWER] ; $20:6DBA: $FA $0E $D8
