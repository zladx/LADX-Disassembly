...
.jr_5176
    ...
    and  $0F                                      ; $5184: $E6 $0F
    jr   nz, ret_017_51A6                         ; $5186: $20 $1E

    ld   a, [wD005]                               ; $5188: $FA $05 $D0
    add  $20                                      ; $518B: $C6 $20
    ld   [wD005], a                               ; $518D: $EA $05 $D0
    jr   nz, ret_017_51A6                         ; $5190: $20 $14
...
.jr_547D
    ...
    and  $0F                                      ; $5484: $E6 $0F
    jr   nz, ret_017_5493                         ; $5486: $20 $0B

    ld   a, [wD005]                               ; $5488: $FA $05 $D0
    and  a                                        ; $548B: $A7
    jr   z, ret_017_5493                          ; $548C: $28 $05
