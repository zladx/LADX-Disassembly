...
DroppableFairyEntityHandler::
    ...
    ld   hl, wEntitiesVelocityXTable              ; $6170: $21 $40 $C2
    add  hl, bc                                   ; $6173: $09
    ld   a, [hl]                                  ; $6174: $7E
    rlca                                          ; $6175: $07
    and  $01                                      ; $6176: $E6 $01
    call SetEntitySpriteVariant                   ; $6178: $CD $0C $3B
    call UpdateEntityPosWithVelocity_03           ; $617B: $CD $25 $7F
...
jr_003_619C:
    ...
    and  $0F                                      ; $61A5: $E6 $0F
    sub  $08                                      ; $61A7: $D6 $08
    ld   hl, wEntitiesVelocityXTable              ; $61A9: $21 $40 $C2
    add  hl, bc                                   ; $61AC: $09
    ld   [hl], a                                  ; $61AD: $77
    call GetRandomByte                            ; $61AE: $CD $0D $28
    and  $0F                                      ; $61B1: $E6 $0F
    sub  $08                                      ; $61B3: $D6 $08
    ld   hl, wEntitiesVelocityYTable              ; $61B5: $21 $50 $C2
    add  hl, bc                                   ; $61B8: $09
    ld   [hl], a                                  ; $61B9: $77
    ret                                           ; $61BA: $C9
