...
.hideoutEnd
    ...
    ld   de, MoblinSpriteVariants                 ; $5839: $11 $17 $59
    ; fallthrough
...
jr_003_58B9:
    ...
    ld   e, a                                     ; $58C0: $5F
    ld   d, b                                     ; $58C1: $50
    ld   hl, RoamingEnemySpeedXPerDirection       ; $58C2: $21 $1B $58
    add  hl, de                                   ; $58C5: $19
    ld   a, [hl]                                  ; $58C6: $7E
    ld   hl, wEntitiesSpeedXTable                 ; $58C7: $21 $40 $C2
    add  hl, bc                                   ; $58CA: $09
    ld   [hl], a                                  ; $58CB: $77
    ld   hl, RoamingEnemySpeedYPerDirection       ; $58CC: $21 $1F $58
    add  hl, de                                   ; $58CF: $19
    ld   a, [hl]                                  ; $58D0: $7E
...
RoamingEnemyState0Handler:
    ...
    ld   a, [hl]                                  ; $58DB: $7E
    and  $0F                                      ; $58DC: $E6 $0F
    jr   nz, .collided                            ; $58DE: $20 $05

    call GetEntityTransitionCountdown             ; $58E0: $CD $05 $0C
    jr   nz, StopWalkingEnd                       ; $58E3: $20 $11
...
RoamingEnemyWalk::
    ...
    ld   e, [hl]                                  ; $5900: $5E
    ld   d, b                                     ; $5901: $50
    ld   hl, SpriteVariantOffsetPerDirection      ; $5902: $21 $23 $58
    add  hl, de                                   ; $5905: $19
    push hl                                       ; $5906: $E5
...
SpawnMoblinArrow::
    ...
    ld   c, a                                     ; $5951: $4F
    ld   hl, MoblinArrowOffsetXPerDirection       ; $5952: $21 $37 $59
    add  hl, bc                                   ; $5955: $09
    ...
    add  hl, de                                   ; $595C: $19
    ld   [hl], a                                  ; $595D: $77
    ld   hl, MoblinArrowOffsetYPerDirection       ; $595E: $21 $3B $59
    add  hl, bc                                   ; $5961: $09
    ...
    add  hl, de                                   ; $5968: $19
    ld   [hl], a                                  ; $5969: $77
    ld   hl, MoblinArrowSpeedXPerDirection        ; $596A: $21 $3F $59
    add  hl, bc                                   ; $596D: $09
    ld   a, [hl]                                  ; $596E: $7E
    ld   hl, wEntitiesSpeedXTable                 ; $596F: $21 $40 $C2
    add  hl, de                                   ; $5972: $19
    ld   [hl], a                                  ; $5973: $77
    ld   hl, MoblinArrowSpeedYPerDirection        ; $5974: $21 $43 $59
    add  hl, bc                                   ; $5977: $09
    ld   a, [hl]                                  ; $5978: $7E
...
SpawnOctorokRock::
    ...
    ld   [hl], a                                  ; $59A6: $77
    ld   c, a                                     ; $59A7: $4F
    ld   hl, OctorokRockOffsetXPerDirection       ; $59A8: $21 $8C $59
    add  hl, bc                                   ; $59AB: $09
    ...
    add  hl, de                                   ; $59B2: $19
    ld   [hl], a                                  ; $59B3: $77
    ld   hl, OctorokRockOffsetYPerDirection       ; $59B4: $21 $8E $59
    add  hl, bc                                   ; $59B7: $09
    ...
    add  hl, de                                   ; $59BE: $19
    ld   [hl], a                                  ; $59BF: $77
    ld   hl, OctorokRockSpeedXPerDirection        ; $59C0: $21 $92 $59
    add  hl, bc                                   ; $59C3: $09
    ld   a, [hl]                                  ; $59C4: $7E
    ld   hl, wEntitiesSpeedXTable                 ; $59C5: $21 $40 $C2
    add  hl, de                                   ; $59C8: $19
    ld   [hl], a                                  ; $59C9: $77
    ld   hl, OctorokRockSpeedYPerDirection        ; $59CA: $21 $94 $59
    add  hl, bc                                   ; $59CD: $09
    ld   a, [hl]                                  ; $59CE: $7E
