...
.jr_5835
    ...
    ld   de, Unknown009SpriteVariants             ; $03:5839: $11 $17 $59
    ; fallthrough
...
jr_003_5896:
    ...
    call func_003_7EFE                            ; $03:58B1: $CD $FE $7E
...
jr_003_58D7:
    ...
    jr   nz, .jr_58E5                             ; $03:58DE: $20 $05

    call GetEntityTransitionCountdown             ; $03:58E0: $CD $05 $0C
    jr   nz, jr_003_58F6                          ; $03:58E3: $20 $11
...
func_003_58FC::
    ...
    ld   e, [hl]                                  ; $03:5900: $5E
    ld   d, b                                     ; $03:5901: $50
    ld   hl, Data_003_5823                        ; $03:5902: $21 $23 $58
...
SpawnMoblinArrow::
    ...
    ld   c, a                                     ; $03:5951: $4F
    ld   hl, Data_003_5937                        ; $03:5952: $21 $37 $59
    ...
    ld   [hl], a                                  ; $03:595D: $77
    ld   hl, Data_003_593B                        ; $03:595E: $21 $3B $59
    ...
    ld   [hl], a                                  ; $03:5969: $77
    ld   hl, Data_003_593F                        ; $03:596A: $21 $3F $59
...
.jr_5974
    ld   hl, Data_003_5943                        ; $03:5974: $21 $43 $59
...
SpawnOctorokRock::
    ...
    ld   [hl], a                                  ; $03:59A6: $77
    ld   c, a                                     ; $03:59A7: $4F
    ld   hl, Data_003_598C                        ; $03:59A8: $21 $8C $59
    ...
    ld   [hl], a                                  ; $03:59B3: $77
    ld   hl, Data_003_598E                        ; $03:59B4: $21 $8E $59
