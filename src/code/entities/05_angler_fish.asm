...
func_005_55CA::
    ...
    ld   [hl], a                                  ; $5601: $77
    add  $20                                      ; $5602: $C6 $20
    ld   [wD202], a                               ; $5604: $EA $02 $D2
    cp   $A8                                      ; $5607: $FE $A8
    jr   c, .jr_5610                              ; $5609: $38 $05
...
jr_005_561E:
    ld   a, [wD201]                               ; $561E: $FA $01 $D2
    inc  a                                        ; $5621: $3C
    ld   [wD201], a                               ; $5622: $EA $01 $D2
    and  $7F                                      ; $5625: $E6 $7F
...
jr_005_5650:
    ...
    ld   a, [hl]                                  ; $5654: $7E
    cp   $0A                                      ; $5655: $FE $0A
    jr   nc, .jr_56B1                             ; $5657: $30 $58

    ld   a, [wD201]                               ; $5659: $FA $01 $D2
    add  $40                                      ; $565C: $C6 $40
    and  $FF                                      ; $565E: $E6 $FF
    ...
    add  hl, bc                                   ; $56A3: $09
    ld   a, [hl]                                  ; $56A4: $7E
    ld   hl, wEntitiesVelocityXTable              ; $56A5: $21 $40 $C2
    add  hl, de                                   ; $56A8: $19
    ld   [hl], a                                  ; $56A9: $77
...
.jr_572A
    ...
    add  hl, de                                   ; $572D: $19
    ld   a, [hl]                                  ; $572E: $7E
    ld   hl, wEntitiesVelocityYTable              ; $572F: $21 $50 $C2
    add  hl, bc                                   ; $5732: $09
    ld   [hl], a                                  ; $5733: $77
    jp   UpdateEntityYPosWithVelocity_05          ; $5734: $C3 $B4 $7A
...
.jr_574A
    ...
    ld   hl, wEntitiesVelocityXTable              ; $574B: $21 $40 $C2
    add  hl, bc                                   ; $574E: $09
    ld   [hl], $D0                                ; $574F: $36 $D0
    call AddEntityVelocityToPos_05                ; $5751: $CD $BE $7A
...
func_005_576E::
    ...
    ld   hl, wEntitiesVelocityXTable              ; $577A: $21 $40 $C2
    add  hl, bc                                   ; $577D: $09
    ld   [hl], $20                                ; $577E: $36 $20
    call AddEntityVelocityToPos_05                ; $5780: $CD $BE $7A
...
.jr_5913
    ...
    ld   a, [hl]                                  ; $591C: $7E
    and  $30                                      ; $591D: $E6 $30
    jr   z, .jr_592A                              ; $591F: $28 $09

    ld   hl, wEntitiesVelocityYTable              ; $5921: $21 $50 $C2
    add  hl, bc                                   ; $5924: $09
    ld   [hl], $F8                                ; $5925: $36 $F8
    call UpdateEntityYPosWithVelocity_05          ; $5927: $CD $B4 $7A
...
func_005_593A::
    ...
    ld   e, $FC                                   ; $595A: $1E $FC
    and  $10                                      ; $595C: $E6 $10
    jr   z, .jr_5962                              ; $595E: $28 $02

    ld   e, $04                                   ; $5960: $1E $04

.jr_5962
    ld   hl, wEntitiesVelocityXTable              ; $5962: $21 $40 $C2
    add  hl, bc                                   ; $5965: $09
    ld   [hl], e                                  ; $5966: $73
    ld   hl, wEntitiesVelocityYTable              ; $5967: $21 $50 $C2
    add  hl, bc                                   ; $596A: $09
    ld   [hl], $0C                                ; $596B: $36 $0C
    call UpdateEntityPosWithVelocity_05           ; $596D: $CD $B1 $7A
...
func_005_5984::
    ld   hl, wEntitiesVelocityXTable              ; $5984: $21 $40 $C2
    add  hl, bc                                   ; $5987: $09
    ld   a, [hl]                                  ; $5988: $7E
    cpl                                           ; $5989: $2F
    rra                                           ; $598A: $1F
    ...
    add  hl, de                                   ; $59BC: $19
    ld   a, [hl]                                  ; $59BD: $7E
    ld   hl, wEntitiesVelocityYTable              ; $59BE: $21 $50 $C2
    add  hl, bc                                   ; $59C1: $09
    add  [hl]                                     ; $59C2: $86
    ld   [hl], a                                  ; $59C3: $77
    ...
    add  hl, de                                   ; $59C7: $19
    cp   [hl]                                     ; $59C8: $BE
    jr   nz, .jr_59CE                             ; $59C9: $20 $03

    call IncrementEntityState                     ; $59CB: $CD $12 $3B

.jr_59CE
    call UpdateEntityPosWithVelocity_05           ; $59CE: $CD $B1 $7A
    call GetEntityTransitionCountdown             ; $59D1: $CD $05 $0C
    jr   nz, .ret_59DD                            ; $59D4: $20 $07
