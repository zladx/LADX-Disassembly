...
jr_005_68F6:
    ...
    add  $06                                      ; $6925: $C6 $06
    cp   $0C                                      ; $6927: $FE $0C
    jr   nc, .jr_6953                             ; $6929: $30 $28

    ld   hl, wEntitiesPosZTable                   ; $692B: $21 $10 $C3
    add  hl, de                                   ; $692E: $19
    ld   a, [hl]                                  ; $692F: $7E
    and  a                                        ; $6930: $A7
    jr   nz, .jr_6953                             ; $6931: $20 $20
...
label_005_6C77:
    ...
    cp   $0E                                      ; $6C87: $FE $0E
    jr   c, .jr_6C92                              ; $6C89: $38 $07

    cp   $22                                      ; $6C8B: $FE $22
    jr   nc, .jr_6C92                             ; $6C8D: $30 $03
