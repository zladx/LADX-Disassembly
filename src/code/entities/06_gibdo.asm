...
label_006_7E9D:
    ...
    jr   nz, .jr_7EBB                             ; $06:7EAA: $20 $0F

    ld   a, [hl]                                  ; $06:7EAC: $7E
    and  $0C                                      ; $06:7EAD: $E6 $0C
    jr   z, jr_006_7EC3                           ; $06:7EAF: $28 $12
...
jr_006_7EC3:
    ...
    ld   a, [hl]                                  ; $06:7EC7: $7E
    and  a                                        ; $06:7EC8: $A7
    jr   nz, .jr_7ED2                             ; $06:7EC9: $20 $07

    call GetRandomByte                            ; $06:7ECB: $CD $0D $28
    and  $3F                                      ; $06:7ECE: $E6 $3F
    jr   nz, jr_006_7EFF                          ; $06:7ED0: $20 $2D
...
.jr_7ED2
    ...
    ld   e, a                                     ; $06:7EDD: $5F
    ld   d, b                                     ; $06:7EDE: $50
    ld   hl, Data_006_7E7F                        ; $06:7EDF: $21 $7F $7E
    ...
    ld   [hl], a                                  ; $06:7EE8: $77
    and  a                                        ; $06:7EE9: $A7
    jr   nz, jr_006_7EFF                          ; $06:7EEA: $20 $13
    ...
    ld   e, a                                     ; $06:7EF3: $5F
    ld   d, b                                     ; $06:7EF4: $50
    ld   hl, Data_006_7E7F                        ; $06:7EF5: $21 $7F $7E
