...
KeeseRestingHandler::
    ...
    jp   nz, label_006_67E6                       ; $06:6752: $C2 $E6 $67

    call func_006_6594                            ; $06:6755: $CD $94 $65
    add  $20                                      ; $06:6758: $C6 $20
    cp   $40                                      ; $06:675A: $FE $40
    jp   nc, label_006_67E6                       ; $06:675C: $D2 $E6 $67

    call func_006_65A4                            ; $06:675F: $CD $A4 $65
    add  $20                                      ; $06:6762: $C6 $20
    cp   $40                                      ; $06:6764: $FE $40
    jp   nc, label_006_67E6                       ; $06:6766: $D2 $E6 $67

    call func_006_65B4                            ; $06:6769: $CD $B4 $65
    ld   d, $00                                   ; $06:676C: $16 $00
    ld   hl, Data_006_672C                        ; $06:676E: $21 $2C $67
...
.jr_6773
    ...
    jp   label_006_67E6                           ; $06:678C: $C3 $E6 $67
...
.jr_67A2
    ...
    ld   a, [hl]                                  ; $06:67A7: $7E
    cp   $0A                                      ; $06:67A8: $FE $0A
    jr   c, label_006_67E6                        ; $06:67AA: $38 $3A
    ...
    jr   nz, label_006_67E6                       ; $06:67D9: $20 $0B
