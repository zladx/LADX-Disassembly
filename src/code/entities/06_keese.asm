...
KeeseRestingHandler::
    ...
    jp   nz, AnimateKeese                         ; $6752: $C2 $E6 $67

    call GetEntityXDistanceToLink_06              ; $6755: $CD $94 $65
    add  $20                                      ; $6758: $C6 $20
    cp   $40                                      ; $675A: $FE $40
    jp   nc, AnimateKeese                         ; $675C: $D2 $E6 $67

    call GetEntityYDistanceToLink_06              ; $675F: $CD $A4 $65
    add  $20                                      ; $6762: $C6 $20
    cp   $40                                      ; $6764: $FE $40
    jp   nc, AnimateKeese                         ; $6766: $D2 $E6 $67

    call GetEntityDirectionToLink_06              ; $6769: $CD $B4 $65
    ld   d, $00                                   ; $676C: $16 $00
    ld   hl, KeeseInitialSpeedIndexPerDirection   ; $676E: $21 $2C $67
    add  hl, de                                   ; $6771: $19
    ld   a, [hl]                                  ; $6772: $7E
...
KeeseFlyingHandler::
    ...
    jr   nz, .skipIncrementState                  ; $6798: $20 $08

    ld   [hl], $20                                ; $679A: $36 $20
    call IncrementEntityState                     ; $679C: $CD $12 $3B
    ld   [hl], b                                  ; $679F: $70
    jr   AnimateKeese                             ; $67A0: $18 $44
...
.skipIncrementState
    ...
    ld   e, [hl]                                  ; $67BE: $5E
    ld   d, b                                     ; $67BF: $50
    ld   hl, KeeseYSpeeds                         ; $67C0: $21 $18 $67
    add  hl, de                                   ; $67C3: $19
    ld   a, [hl]                                  ; $67C4: $7E
    ld   hl, wEntitiesSpeedYTable                 ; $67C5: $21 $50 $C2
    add  hl, bc                                   ; $67C8: $09
    ld   [hl], a                                  ; $67C9: $77
    ld   hl, KeeseXSpeeds                         ; $67CA: $21 $1C $67
    add  hl, de                                   ; $67CD: $19
    ld   a, [hl]                                  ; $67CE: $7E
