...
PeaHatEntityHandler::
    ...
    JP_TABLE                                      ; $07:672F
._00 dw func_007_6736                             ; $07:6730
._01 dw func_007_6790                             ; $07:6732
._02 dw func_007_67D7                             ; $07:6734
...
func_007_6736::
    ...
    ld   a, [hl]                                  ; $07:673A: $7E
    and  a                                        ; $07:673B: $A7
    jr   z, .jr_6747                              ; $07:673C: $28 $09

    ldh  a, [hFrameCounter]                       ; $07:673E: $F0 $E7
    and  $07                                      ; $07:6740: $E6 $07
    jr   nz, jr_007_6753                          ; $07:6742: $20 $0F

    dec  [hl]                                     ; $07:6744: $35
    jr   jr_007_6753                              ; $07:6745: $18 $0C
...
jr_007_6753:
    ...
    jr   nz, jr_007_6776                          ; $07:6757: $20 $1D

    ld   hl, wEntitiesSpeedXTable                 ; $07:6759: $21 $40 $C2
    add  hl, bc                                   ; $07:675C: $09
    ld   a, [hl]                                  ; $07:675D: $7E
    and  a                                        ; $07:675E: $A7
    jr   z, jr_007_6768                           ; $07:675F: $28 $07

    and  $80                                      ; $07:6761: $E6 $80
    jr   z, .jr_6767                              ; $07:6763: $28 $02
...
jr_007_6768:
    ...
    ld   a, [hl]                                  ; $07:676B: $7E
    and  a                                        ; $07:676C: $A7
    jr   z, jr_007_6776                           ; $07:676D: $28 $07

    and  $80                                      ; $07:676F: $E6 $80
    jr   z, .jr_6775                              ; $07:6771: $28 $02
...
jr_007_6776:
    call GetEntityDropTimer                       ; $07:6776: $CD $FB $0B
    jr   nz, .jr_677E                             ; $07:6779: $20 $03
...
.jr_677E
    ...
    ld   a, [hl]                                  ; $07:6782: $7E
    and  a                                        ; $07:6783: $A7
    jr   z, .jr_678D                              ; $07:6784: $28 $07

    ldh  a, [hFrameCounter]                       ; $07:6786: $F0 $E7
    and  $1F                                      ; $07:6788: $E6 $1F
    jr   nz, .jr_678D                             ; $07:678A: $20 $01

    dec  [hl]                                     ; $07:678C: $35

.jr_678D
    jp   func_007_67AE                            ; $07:678D: $C3 $AE $67
...
func_007_6790::
    ...
    ld   a, [hl]                                  ; $07:6794: $7E
    cp   $08                                      ; $07:6795: $FE $08
    jr   c, .jr_67A7                              ; $07:6797: $38 $0E

    call GetEntityDropTimer                       ; $07:6799: $CD $FB $0B
...
.jr_67A7
    ...
    jr   nz, func_007_67AE                        ; $07:67AB: $20 $01
...
jr_007_67EB:
    call GetEntityDropTimer                       ; $07:67EB: $CD $FB $0B
    jr   nz, .jr_67F6                             ; $07:67EE: $20 $06
...
.jr_67F6
    ...
    ld   e, [hl]                                  ; $07:6812: $5E
    ld   d, b                                     ; $07:6813: $50
    ld   hl, Data_007_67C3                        ; $07:6814: $21 $C3 $67
    add  hl, de                                   ; $07:6817: $19
    ld   a, [hl]                                  ; $07:6818: $7E
    sra  a                                        ; $07:6819: $CB $2F
    call GetEntitySpeedYAddress                   ; $07:681B: $CD $05 $40
    ld   [hl], a                                  ; $07:681E: $77
    ld   hl, Data_007_67C7                        ; $07:681F: $21 $C7 $67
