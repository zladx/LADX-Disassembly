...
.default
    ...
    cp   $07                                      ; $07:6009: $FE $07
    jr   nz, jr_007_602A                          ; $07:600B: $20 $1D
...
jr_007_602A:
    ld   de, Data_007_6003                        ; $07:602A: $11 $03 $60
    ...
    jr   z, jr_007_608F                           ; $07:606B: $28 $22
...
jr_007_608F:
    ...
    JP_TABLE                                      ; $07:60BA
._00 dw func_007_60C1                             ; $07:60BB
._01 dw func_007_6134                             ; $07:60BD
._02 dw func_007_6135                             ; $07:60BF

func_007_60C1::
    ldh  a, [hDungeonFloorTile]                   ; $07:60C1: $F0 $E9
    dec  a                                        ; $07:60C3: $3D
    and  $80                                      ; $07:60C4: $E6 $80
    jr   z, jr_007_60DD                           ; $07:60C6: $28 $15

    ld   hl, wEntitiesSpeedYTable                 ; $07:60C8: $21 $50 $C2
    call func_007_60D1                            ; $07:60CB: $CD $D1 $60
...
func_007_60D1::
    ...
    ld   a, [hl]                                  ; $07:60D2: $7E
    and  a                                        ; $07:60D3: $A7
    jr   z, jr_007_60DD                           ; $07:60D4: $28 $07

    and  $80                                      ; $07:60D6: $E6 $80
    jr   z, .jr_60DC                              ; $07:60D8: $28 $02
...
ENDC
    ...
    cp   $07                                      ; $07:6110: $FE $07
    jr   z, ret_007_6133                          ; $07:6112: $28 $1F
...
jr_007_6172:
    ...
    ld   a, [hl]                                  ; $07:6176: $7E
    and  a                                        ; $07:6177: $A7
    jr   z, .jr_6188                              ; $07:6178: $28 $0E

    ld   hl, wEntitiesTypeTable                   ; $07:617A: $21 $A0 $C3
    add  hl, de                                   ; $07:617D: $19
    ld   a, [hl]                                  ; $07:617E: $7E
    cp   $A7                                      ; $07:617F: $FE $A7
    jr   nz, .jr_6188                             ; $07:6181: $20 $05

    push de                                       ; $07:6183: $D5
    call func_007_618F                            ; $07:6184: $CD $8F $61
    pop  de                                       ; $07:6187: $D1
...
.jr_6188
    ...
    ld   a, e                                     ; $07:6189: $7B
    cp   $FF                                      ; $07:618A: $FE $FF
    jr   nz, jr_007_6172                          ; $07:618C: $20 $E4

    ret                                           ; $07:618E: $C9

func_007_618F::
    call GetEntityTransitionCountdown             ; $07:618F: $CD $05 $0C
    jr   nz, .ret_61CD                            ; $07:6192: $20 $39
    ...
    cp   $28                                      ; $07:61AA: $FE $28
    jr   nc, .ret_61CD                            ; $07:61AC: $30 $1F

    call func_007_6142                            ; $07:61AE: $CD $42 $61
