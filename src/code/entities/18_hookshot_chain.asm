LinkDirectionToLinkAnimationState_3::
    db  LINK_ANIMATION_STATE_HOOKSHOT_CHAIN_RIGHT
    db  LINK_ANIMATION_STATE_HOOKSHOT_CHAIN_LEFT
    db  LINK_ANIMATION_STATE_HOOKSHOT_CHAIN_UP
    db  LINK_ANIMATION_STATE_HOOKSHOT_CHAIN_DOWN
...
.interactWithWorld
    ; Damage enemies.
    ld   a, DAMAGE_TYPE_HOOKSHOT                  ;; 18:7C54 $3E $06
    ld   [wAttackDamageType], a                   ;; 18:7C56 $EA $9E $C1
...
.loop
    ...
    ; Each link is only visible every two frames.
...
.jr_7D09
    ...
    ld   [de], a                                  ;; 18:7D16 $12
    inc  de                                       ;; 18:7D17 $13
    ld   a, OAM_GBC_PAL_0 | OAMF_PAL0             ;; 18:7D18 $3E $00
    ld   [de], a                                  ;; 18:7D1A $12
    inc  de                                       ;; 18:7D1B $13
