MadBatterEntityHandler::
    ...
    ld   a, [hl]                                  ; $18:4EE1: $7E
    and  a                                        ; $18:4EE2: $A7
    jp   nz, label_018_50E2                       ; $18:4EE3: $C2 $E2 $50
...
label_018_50E2:
    ...
    and  a                                        ; $18:50EE: $A7
    jr   nz, jr_018_50FE                          ; $18:50EF: $20 $0D

    ld   a, d                                     ; $18:50F1: $7A
    bit  1, a                                     ; $18:50F2: $CB $4F
    ld   a, $E4                                   ; $18:50F4: $3E $E4
    jr   z, .jr_50FA                              ; $18:50F6: $28 $02
...
jr_018_50FE:
    ...
    ld   a, BANK(func_024_7B77)                   ; $18:5101: $3E $24
    ld   [hl+], a                                 ; $18:5103: $22
    ld   a, HIGH(func_024_7B77)                   ; $18:5104: $3E $7B
    ld   [hl+], a                                 ; $18:5106: $22
    ld   a, LOW(func_024_7B77)                    ; $18:5107: $3E $77
    ld   [hl+], a                                 ; $18:5109: $22
