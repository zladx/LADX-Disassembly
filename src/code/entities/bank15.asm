...
jr_015_4445:
    ld   hl, wEntitiesStateTable                        ; $4445: $21 $80 $C2
    add  hl, de                                   ; $4448: $19
    ld   a, [hl]                                  ; $4449: $7E
    cp   $05                                      ; $444A: $FE $05
...
jr_015_5468:
    ld   hl, wEntitiesStateTable                        ; $5468: $21 $80 $C2
    add  hl, de                                   ; $546B: $19
    ld   a, [hl]                                  ; $546C: $7E
    cp   $05                                      ; $546D: $FE $05
...
jr_015_7433:
    ...
    ld   hl, wEntitiesStateTable                        ; $7463: $21 $80 $C2
    add  hl, bc                                   ; $7466: $09
    ld   a, [hl]                                  ; $7467: $7E
...
func_015_7A6E:
    ...
    ld   hl, wEntitiesStateTable + $0F                        ; $7A87: $21 $8F $C2
    add  hl, de                                   ; $7A8A: $19
    ld   [hl], $00                                ; $7A8B: $36 $00
...
func_015_7C31:
label_015_7C31:
    ld   hl, wEntitiesStateTable                        ; $7C31: $21 $80 $C2
    add  hl, bc                                   ; $7C34: $09
    ld   [hl], b                                  ; $7C35: $70
    ret                                           ; $7C36: $C9
