...
WarpState0Handler::
    ...
    ld   a, $1B                                   ; $429D: $3E $1B
    ld   [wPlayMusicTrack], a                   ; $429F: $EA $68 $D3
    ret                                           ; $42A2: $C9
...
jr_019_46A2:
    ...
    ld   a, $10                                   ; $46D5: $3E $10
    ld   [wPlayMusicTrack], a                   ; $46D7: $EA $68 $D3
    ret                                           ; $46DA: $C9
...
jr_019_4707:
    ...
    ld   a, $10                                   ; $471F: $3E $10
    ld   [wPlayMusicTrack], a                   ; $4721: $EA $68 $D3
    ret                                           ; $4724: $C9
...
jr_019_4B57:
    ld   a, e                                     ; $4B57: $7B
    ld   [wPlayMusicTrack], a                   ; $4B58: $EA $68 $D3
...
func_019_4DBC::
    ...
    ld   [hl], $C1                                ; $4DF5: $36 $C1
    ld   a, $55                                   ; $4DF7: $3E $55
    ld   [wPlayMusicTrack], a                   ; $4DF9: $EA $68 $D3
...
func_019_4E43::
    ...
    ld   a, $10                                   ; $4E5C: $3E $10
    ld   [wPlayMusicTrack], a                   ; $4E5E: $EA $68 $D3
...
func_019_500D::
    ...
    inc  [hl]                                     ; $5021: $34
    ld   a, $57                                   ; $5022: $3E $57
    ld   [wPlayMusicTrack], a                   ; $5024: $EA $68 $D3
...
EaglesTowerOpeningState5Handler::
    ...
    ld   [wPlayMusicTrack], a                   ; $62B0: $EA $68 $D3
    ret                                           ; $62B3: $C9
...
jr_019_68E4:
    ...
    ld   [wPlayMusicTrack], a                   ; $68F3: $EA $68 $D3
...
jr_019_72AC:
    ...
    ld   [hl], $01                                ; $72B8: $36 $01
    ld   a, $56                                   ; $72BA: $3E $56
    ld   [wPlayMusicTrack], a                   ; $72BC: $EA $68 $D3
...
func_019_76B1::
    ...
    ld   a, $0F                                   ; $76C0: $3E $0F
    ld   [wPlayMusicTrack], a                   ; $76C2: $EA $68 $D3
...
jr_019_76D6:
    ...
    ld   [hl], $20                                ; $76DF: $36 $20
    ld   a, $10                                   ; $76E1: $3E $10
    ld   [wPlayMusicTrack], a                   ; $76E3: $EA $68 $D3
