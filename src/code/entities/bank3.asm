...
.masterStalfosEnd
    ...
    ld   hl, wEntitiesOptions1Table               ; $48FC: $21 $30 $C4
    add  hl, bc                                   ; $48FF: $09
    ld   a, [hl]                                  ; $4900: $7E
    and  $04                                      ; $4901: $E6 $04
...
EntityInitBowWow::
    ...
    cp   BOW_WOW_HAS_BEEN_KIDNAPPED               ; $4A64: $FE $80
...
EntityInitMadamMeowMeow::
    ...
    cp   BOW_WOW_HAS_BEEN_KIDNAPPED               ; $4B11: $FE $80
...
EntityDeathHandler::
    ld   hl, wEntitiesOptions1Table               ; $5518: $21 $30 $C4
    add  hl, bc                                   ; $551B: $09
    ld   a, [hl]                                  ; $551C: $7E
    and  $80                                      ; $551D: $E6 $80
IF __PATCH_0__
...
AfterSirensInstrumentD1::
    ...
    ld   a, BOW_WOW_HAS_BEEN_KIDNAPPED            ; $5E0C: $3E $80
...
.bouncingBombiteEnd
    ...
    ld   hl, wEntitiesOptions1Table               ; $6EFB: $21 $30 $C4
    add  hl, bc                                   ; $6EFE: $09
    and  $40                                      ; $6EFF: $E6 $40
...
.jr_7235
    ...
    inc  [hl]                                     ; $7255: $34
    inc  [hl]                                     ; $7256: $34
    ld   hl, wEntitiesOptions1Table               ; $7257: $21 $30 $C4
    add  hl, bc                                   ; $725A: $09
    ld   a, [hl]                                  ; $725B: $7E
    and  $C2                                      ; $725C: $E6 $C2
    ld   [hl], a                                  ; $725E: $77
...
.jr_72C2
    ...
    add  hl, bc                                   ; $72C5: $09
    ld   [hl], $01                                ; $72C6: $36 $01
    ld   hl, wEntitiesOptions1Table               ; $72C8: $21 $30 $C4
    add  hl, bc                                   ; $72CB: $09
    ld   a, [hl]                                  ; $72CC: $7E
    bit  7, a                                     ; $72CD: $CB $7F
...
jr_003_733E:
    ...
    xor  a                                        ; $734C: $AF
    ld   [hl], a                                  ; $734D: $77
    ld   hl, wEntitiesOptions1Table               ; $734E: $21 $30 $C4
    add  hl, bc                                   ; $7351: $09
    ld   a, [hl]                                  ; $7352: $7E
    and  $80                                      ; $7353: $E6 $80
...
.jr_78B1
    ...
    add  hl, bc                                   ; $78B4: $09
    ld   [hl], b                                  ; $78B5: $70
    ld   hl, wEntitiesOptions1Table               ; $78B6: $21 $30 $C4
    add  hl, bc                                   ; $78B9: $09
    ld   a, [hl]                                  ; $78BA: $7E
    bit  4, a                                     ; $78BB: $CB $67
...
jr_003_790C:
    ld   hl, wEntitiesOptions1Table               ; $790C: $21 $30 $C4
    add  hl, bc                                   ; $790F: $09
    ld   a, [hl]                                  ; $7910: $7E
    and  $08                                      ; $7911: $E6 $08
...
.jr_7BA7
    ...
    ld   hl, wEntitiesOptions1Table               ; $7BB1: $21 $30 $C4
    add  hl, bc                                   ; $7BB4: $09
    ld   a, [hl]                                  ; $7BB5: $7E
    and  $80                                      ; $7BB6: $E6 $80
...
hookshotEnd:
    ...
    ld   hl, wEntitiesOptions1Table               ; $7C91: $21 $30 $C4
    add  hl, bc                                   ; $7C94: $09
    ld   a, [hl]                                  ; $7C95: $7E
    and  $01                                      ; $7C96: $E6 $01
