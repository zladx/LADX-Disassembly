...
jr_036_4063:
    ld   a, [hl+]                                 ; $4063: $2A
    and  a                                        ; $4064: $A7
    jr   z, .jr_406E                              ; $4065: $28 $07

    cp   $FA                                      ; $4067: $FE $FA
    jr   z, .jr_406E                              ; $4069: $28 $03
...
jr_036_4444:
    ...
    and  a                                        ; $4456: $A7
    jr   z, .jr_4466                              ; $4457: $28 $0D

    cp   $01                                      ; $4459: $FE $01
    jr   z, .jr_4466                              ; $445B: $28 $09

    cp   $22                                      ; $445D: $FE $22
    jr   z, .jr_4466                              ; $445F: $28 $05

    cp   $23                                      ; $4461: $FE $23
    jr   z, .jr_4466                              ; $4463: $28 $01
...
.jr_469A
    cp   $01                                      ; $469A: $FE $01
    jr   nz, .jr_46A9                             ; $469C: $20 $0B

    ldh  a, [hIsGBC]                              ; $469E: $F0 $FE
    and  a                                        ; $46A0: $A7
    jr   z, .jr_46A9                              ; $46A1: $28 $06
...
func_036_58A1::
    ...
    and  a                                        ; $58A4: $A7
    jr   z, ret_036_58B8                          ; $58A5: $28 $11

    cp   $05                                      ; $58A7: $FE $05
    jr   nc, ret_036_58B8                         ; $58A9: $30 $0D
...
.jr_6273
    ...
    ld   a, [hl]                                  ; $6279: $7E
    and  $03                                      ; $627A: $E6 $03
    jr   nz, ret_036_629E                         ; $627C: $20 $20

    ld   hl, wEntitiesIgnoreHitsCountdownTable    ; $627E: $21 $10 $C4
    add  hl, bc                                   ; $6281: $09
    ld   a, [hl]                                  ; $6282: $7E
    and  a                                        ; $6283: $A7
    jr   z, ret_036_629E                          ; $6284: $28 $18
...
.loop_71BA:
    ...
    jr   z, .jr_71C7                              ; $71BD: $28 $08

    dec  e                                        ; $71BF: $1D
    ld   a, e                                     ; $71C0: $7B
    and  a                                        ; $71C1: $A7
    jr   nz, .loop_71BA                           ; $71C2: $20 $F6
