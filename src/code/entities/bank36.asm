...
jr_036_4011:
    ...
    ld   de, wEntitiesStateTable                        ; $405D: $11 $80 $C2
...
Func_036_4BE8::
    ...
    ld   e, a                                     ; $4BEB: $5F
    ld   d, $00                                   ; $4BEC: $16 $00
    ld   hl, wEntitiesStateTable                        ; $4BEE: $21 $80 $C2
    add  hl, de                                   ; $4BF1: $19
    ld   a, [hl]                                  ; $4BF2: $7E
    cp   $01                                      ; $4BF3: $FE $01
...
jr_036_4E84:
    ...
    ld   hl, wEntitiesStateTable                        ; $4E8D: $21 $80 $C2
    add  hl, de                                   ; $4E90: $19
    ld   a, [hl]                                  ; $4E91: $7E
    and  a                                        ; $4E92: $A7
...
Func_036_4F9B::
    ...
    ld   e, a                                     ; $4F9E: $5F
    ld   d, $00                                   ; $4F9F: $16 $00
    ld   hl, wEntitiesStateTable                        ; $4FA1: $21 $80 $C2
    add  hl, de                                   ; $4FA4: $19
    ld   a, [hl]                                  ; $4FA5: $7E
    cp   $01                                      ; $4FA6: $FE $01
...
jr_036_5465:
    ...
    ld   hl, wEntitiesStateTable                        ; $546E: $21 $80 $C2
    add  hl, de                                   ; $5471: $19
    ld   a, [hl]                                  ; $5472: $7E
    and  a                                        ; $5473: $A7
    ret  nz                                       ; $5474: $C0
...
jr_036_54D3:
    ...
    add  hl, bc                                   ; $54D6: $09
    ld   [hl], $00                                ; $54D7: $36 $00
    ld   hl, wEntitiesStateTable                        ; $54D9: $21 $80 $C2
    add  hl, bc                                   ; $54DC: $09
    ld   a, $01                                   ; $54DD: $3E $01
    ld   [hl], a                                  ; $54DF: $77
    pop  af                                       ; $54E0: $F1
...
jr_036_5603:
    ...
    add  hl, bc                                   ; $5625: $09
    ld   [hl], e                                  ; $5626: $73
    ld   hl, wEntitiesStateTable                        ; $5627: $21 $80 $C2
    add  hl, bc                                   ; $562A: $09
    ld   [hl], $05                                ; $562B: $36 $05
...
jr_036_5B59:
    ...
    nop                                           ; $5B63: $00
    ld   hl, wEntitiesStateTable                        ; $5B64: $21 $80 $C2
    add  hl, de                                   ; $5B67: $19
    ld   a, [hl]                                  ; $5B68: $7E
    cp   $01                                      ; $5B69: $FE $01
...
jr_036_5EC7:
    ...
    ld   hl, wEntitiesStateTable                        ; $5ED0: $21 $80 $C2
    add  hl, de                                   ; $5ED3: $19
    ld   a, [hl]                                  ; $5ED4: $7E
    and  a                                        ; $5ED5: $A7
...
jr_036_66F9:
    ...
    ld   hl, wEntitiesStateTable                        ; $6702: $21 $80 $C2
    add  hl, de                                   ; $6705: $19
    ld   a, [hl]                                  ; $6706: $7E
    and  a                                        ; $6707: $A7
    ret  nz                                       ; $6708: $C0
...
jr_036_6970:
    ld   hl, wEntitiesStateTable                        ; $6970: $21 $80 $C2
    add  hl, de                                   ; $6973: $19
    ld   a, [hl]                                  ; $6974: $7E
    and  a                                        ; $6975: $A7
...
func_036_6B5C:
    ...
    ld   hl, wEntitiesStateTable + $0F                        ; $6B75: $21 $8F $C2
    add  hl, de                                   ; $6B78: $19
    ld   [hl], $00                                ; $6B79: $36 $00
...
func_036_6C89:
label_036_6C89:
    ld   hl, wEntitiesStateTable                        ; $6C89: $21 $80 $C2
    add  hl, bc                                   ; $6C8C: $09
    ld   [hl], $00                                ; $6C8D: $36 $00
    ret                                           ; $6C8F: $C9
