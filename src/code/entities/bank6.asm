...
CrazyTracyEntityHandler::
    ...
    sub  $10                                      ; $5EB8: $D6 $10
    ldh  [$FFEC], a                               ; $5EBA: $E0 $EC    ld   a, $6C                                   ; $5EBC: $3E $6C
...
jr_006_5EEE:
    ...
    JP_TABLE                                      ; $5F18
._00 dw CrazyTracyState0Handler
._01 dw CrazyTracyState1Handler
._02 dw CrazyTracyState2Handler
._03 dw CrazyTracyState3Handler
._04 dw CrazyTractState4Handler
...
CrazyTracyState2Handler::
    ...
    add  hl, de                                   ; $5FA7: $19
    ld   a, [hl]                                  ; $5FA8: $7E
    ld   hl, Data_006_5F81                        ; $5FA9: $21 $81 $5F
    add  hl, de                                   ; $5FAC: $19
    ld   e, [hl]                                  ; $5FAD: $5E
    ld   d, a                                     ; $5FAE: $57
...
jr_006_5FBD:
    ...
    jr   nz, buyTracyMedecine                     ; $5FC6: $20 $0D
...
buyTracyMedecine:
    ...
    ld   e, [hl]                                  ; $5FD9: $5E
    ld   d, b                                     ; $5FDA: $50
    ld   hl, Data_006_5F89                        ; $5FDB: $21 $89 $5F
    add  hl, de                                   ; $5FDE: $19
...
CrazyTracyState3Handler::
    ld   a, [wDialogState]                        ; $601C: $FA $9F $C1
    and  a                                        ; $601F: $A7
    jr   nz, .return                              ; $6020: $20 $02

    jr   buyTracyMedecine                         ; $6022: $18 $B1

.return
    ret                                           ; $6024: $C9

CrazyTractState4Handler::
