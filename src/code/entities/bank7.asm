...
func_007_7D1A::
    ...
    ld   e, [hl]                                  ; $07:7D1E: $5E
    ld   d, b                                     ; $07:7D1F: $50
    ld   hl, Data_007_7D16                        ; $07:7D20: $21 $16 $7D
...
jr_007_7D4E:
    ...
    push de                                       ; $07:7D63: $D5
    call func_007_7E7D                            ; $07:7D64: $CD $7D $7E
...
func_007_7E7D::
    call EntityLinkPositionXDifference_07         ; $07:7E7D: $CD $5D $7E
    ld   a, e                                     ; $07:7E80: $7B
    ldh  [hMultiPurpose0], a                      ; $07:7E81: $E0 $D7
    ld   a, d                                     ; $07:7E83: $7A
    bit  7, a                                     ; $07:7E84: $CB $7F
    jr   z, .jr_7E8A                              ; $07:7E86: $28 $02
...
.jr_7E8A
    push af                                       ; $07:7E8A: $F5
    call EntityLinkPositionYDifference_07         ; $07:7E8B: $CD $6D $7E
    ld   a, e                                     ; $07:7E8E: $7B
    ldh  [hMultiPurpose1], a                      ; $07:7E8F: $E0 $D8
    ld   a, d                                     ; $07:7E91: $7A
    bit  7, a                                     ; $07:7E92: $CB $7F
    jr   z, .jr_7E98                              ; $07:7E94: $28 $02
...
.jr_7E98
    pop  de                                       ; $07:7E98: $D1
    cp   d                                        ; $07:7E99: $BA
    jr   nc, .jr_7EA0                             ; $07:7E9A: $30 $04

    ldh  a, [hMultiPurpose0]                      ; $07:7E9C: $F0 $D7
    jr   jr_007_7EA2                              ; $07:7E9E: $18 $02
