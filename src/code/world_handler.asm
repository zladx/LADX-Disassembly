...
label_001_4555::
    ...
    ld   a, [SaveGame3 + 5 + wDeathCount - wOverworldRoomStatus]                               ; $4639: $FA $B6 $AB
    ld   [wFile3DeathCountHigh], a                ; $463C: $EA $04 $DC
    call EnableExternalRAMWriting                 ; $463F: $CD $D0 $27
    ld   a, [SaveGame3 + 5 + wDeathCount - wOverworldRoomStatus + 1]                               ; $4642: $FA $B7 $AB
