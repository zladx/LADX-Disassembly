...
LINK_ANIMATION_STATE_UNKNOWN_LEFT   equ $10
LINK_ANIMATION_STATE_UNKNOWN_RIGHT  equ $11
...
LINK_ANIMATION_STATE_UNKNOWN_DOWN   equ $0E
LINK_ANIMATION_STATE_UNKNOWN_UP     equ $0F
