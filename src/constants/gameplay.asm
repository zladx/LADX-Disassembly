...
LINK_ANIMATION_STATE_UNKNOWN_22            equ $22
...
LINK_ANIMATION_STATE_UNKNOWN_4C            equ $4C
LINK_ANIMATION_STATE_UNKNOWN_4E            equ $4E
LINK_ANIMATION_STATE_UNKNOWN_4F            equ $4F
...
LINK_ANIMATION_STATE_UNKNOWN_58            equ $58
