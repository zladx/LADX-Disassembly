...
EFFECT_FIELDS = (
    ...
    Field("is_shooting_arrow", "wIsShootingArrow"),
    Field("active_projectile_count", "wActiveProjectileCount"),
    Field("bomb_arrow_cooldown", "wBombArrowCooldown"),
    Field("latest_shot_arrow_entity_slot", "wLatestShotArrowEntityIndex"),
)
...
ENTITY_TABLES = {
    ...
    "x_sign": "wEntitiesPosXSignTable",
    "y_sign": "wEntitiesPosYSignTable",
    "speed_x": "wEntitiesSpeedXTable",
    "speed_y": "wEntitiesSpeedYTable",
    "speed_z": "wEntitiesSpeedZTable",
    "acceleration_x": "wEntitiesSpeedXAccTable",
    "acceleration_y": "wEntitiesSpeedYAccTable",
    "acceleration_z": "wEntitiesSpeedZAccTable",
    "status": "wEntitiesStatusTable",
    "state": "wEntitiesStateTable",
    "collision_flags": "wEntitiesCollisionsTable",
    ...
    "inertia": "wEntitiesInertiaTable",
    "ignore_hits_countdown": "wEntitiesIgnoreHitsCountdownTable",
    "flash_countdown": "wEntitiesFlashCountdownTable",
    "options1": "wEntitiesOptions1Table",
    "load_order": "wEntitiesLoadOrderTable",
    "lifted_state": "wEntitiesLiftedTable",
    "power_recoil": "wEntitiesPowerRecoilingTable",
    "falling_target_x": "wEntitiesFallingTargetXTable",
    "falling_target_y": "wEntitiesFallingTargetYTable",
    "dropped_item": "wEntitiesDroppedItemTable",
    "thrown_direction": "wEntitiesThrownDirectionTable",
